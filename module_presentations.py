  ...
  ("battle_2",0,0,[
      (ti_on_presentation_load,
       [(set_fixed_point_multiplier, 1000),
        ...
        (create_button_overlay, "$g_presentation_obj_10", "@Hold This Position", tf_center_justify),
        (overlay_set_color, "$g_presentation_obj_10", color_neutral_news),
        (create_button_overlay, "$g_presentation_obj_11", "@Follow Me", tf_center_justify),
        (overlay_set_color, "$g_presentation_obj_11", color_neutral_news),
        (create_button_overlay, "$g_presentation_obj_12", "@Charge", tf_center_justify),
        (overlay_set_color, "$g_presentation_obj_12", color_neutral_news),
        (create_button_overlay, "$g_presentation_obj_13", "@Advance", tf_center_justify),
        (overlay_set_color, "$g_presentation_obj_13", color_neutral_news),
        (create_button_overlay, "$g_presentation_obj_14", "@Fall Back", tf_center_justify),
        (overlay_set_color, "$g_presentation_obj_14", color_neutral_news),
        (create_button_overlay, "$g_presentation_obj_15", "@Stand Closer", tf_center_justify),
        (overlay_set_color, "$g_presentation_obj_15", color_neutral_news),
        (create_button_overlay, "$g_presentation_obj_16", "@Spread Out", tf_center_justify),
        (overlay_set_color, "$g_presentation_obj_16", color_neutral_news),
        (create_button_overlay, "$g_presentation_obj_17", "@Stand Ground", tf_center_justify),
        (overlay_set_color, "$g_presentation_obj_17", color_neutral_news),
        (create_button_overlay, "$g_presentation_obj_18", "@Mount", tf_center_justify),
        (overlay_set_color, "$g_presentation_obj_18", color_neutral_news),
        (create_button_overlay, "$g_presentation_obj_19", "@Dismount", tf_center_justify),
        (overlay_set_color, "$g_presentation_obj_19", color_neutral_news),
        (create_button_overlay, "$g_presentation_obj_20", "@Use Any Weapon", tf_center_justify),
        (overlay_set_color, "$g_presentation_obj_20", color_neutral_news),
        (create_button_overlay, "$g_presentation_obj_21", "@Use Blunt Weapons", tf_center_justify),
        (overlay_set_color, "$g_presentation_obj_21", color_neutral_news),
        ...
        (create_text_overlay, "$g_presentation_obj_22", "@Us", 0),
        (overlay_set_color, "$g_presentation_obj_22", color_great_news),
        (create_text_overlay, "$g_presentation_obj_24", "@Enemies", 0),
        (overlay_set_color, "$g_presentation_obj_24", color_great_news),
        (create_text_overlay, "$g_presentation_obj_25", "@Ready", tf_center_justify),
        (overlay_set_color, "$g_presentation_obj_25", color_good_news),
        (create_text_overlay, "$g_presentation_obj_26", "@Wounded", tf_center_justify),
        (overlay_set_color, "$g_presentation_obj_26", color_good_news),
        (create_text_overlay, "$g_presentation_obj_27", "@Dead", tf_center_justify),
        (overlay_set_color, "$g_presentation_obj_27", color_good_news),
        ...
        (create_text_overlay, "$g_presentation_obj_23", "@Allies", 0),
        (overlay_set_color, "$g_presentation_obj_23", color_great_news),
        (create_text_overlay, "$g_battle_allies_ready", s7, tf_center_justify),
        (create_text_overlay, "$g_battle_allies_wounded", s7, tf_center_justify),
        (create_text_overlay, "$g_battle_allies_dead", s7, tf_center_justify),
...
(ti_on_presentation_load, [
  ...
  (store_add, ":last_culture", "fac_culture_3", 1),
  (try_for_range, ":culture", "fac_culture_1", ":last_culture"),
    (try_begin),
      (eq, ":culture", "fac_culture_1"),
      (str_store_string, s1, "@Galactic Empire"),
    (else_try),
      (eq, ":culture", "fac_culture_2"),
      (str_store_string, s1, "@Rebel Alliance"),
    (else_try),
      (str_store_string, s1, "@Hutt Cartel"),
    (try_end),
  ...
  (str_store_string, s1, "@Human Mercenaries"),
  (overlay_add_item, "$g_presentation_obj_sliders_1", s1),
  
  #Force Sensitive
  (str_store_troop_name, s1, "trp_force_sensitive_recruit"),
  (str_store_string, s1, "@Force Sensitive"),
  (overlay_add_item, "$g_presentation_obj_sliders_1", s1),
  ...
  (else_try),
    (eq, ":extra", 1),
    (assign, ":troop", "trp_force_sensitive_recruit"),
    (call_script, "script_troop_tree_precurse", ":troop", 1, 1),
    (store_div, "$troop_tree_pic_width", Troop_Tree_Area_Width, reg0),
    (store_div, "$troop_tree_pic_height", Troop_Tree_Area_Height, reg1),
  (try_end),
...
[
  ...
  (try_begin),
    (eq, ":cmdr_faction","fac_galacticempire"), #Galactic Empire
    (create_mesh_overlay, reg0, "mesh_pic_arms_swadian"),
  (else_try),
    (eq, ":cmdr_faction","fac_rebelalliance"), #Rebel ALLIANCE
    (create_mesh_overlay, reg0, "mesh_pic_arms_vaegir"),
  (else_try),
    (eq, ":cmdr_faction","fac_huttcartel"), #Hutt Cartel
...
("customize_weapon", prsntf_manual_end_only, 0, [ 
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (create_mesh_overlay_with_item_id, "$g_presentation_credits_obj_1", "$g_current_opened_item_details"),
      (position_set_x, pos1, 494),
