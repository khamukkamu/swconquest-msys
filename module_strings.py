...
#SW - spaceship strings start
  ...
  ("spaceship_imperial_star_destroyer_desc", "The centerpiece of any respectable Imperial fleet, the Imperial Star Destroyer^ is both heavily armed and spacious."),
  ...
  ("spaceship_imperial_star_destroyer_interdictor_desc", "Based on the same design as the Imperial Star Destroyer, the Interdictor^ is faster to address the Imperial-class' poor interception ability."),
  ("spaceship_imperial_dreadnaught_frigate_name", "Imperial Dreadnaught Heavy Cruiser"),
  ("spaceship_imperial_dreadnaught_frigate_desc", "The Imperial Dreadnought might be outdated, but it features^ great potential for upgrade in an economical package."),
  ...
  ("spaceship_imperial_trade_frigate_desc", "The standard Imperial Trade Frigate combines acceptable engine speed ^and lots of space for either troops or cargo."),
  ...
  ("spaceship_rebel_transport_desc", "The Gallofree Medium Transport's modularity allows upgrades in virtually any area, ^but must be improved to be a significant threat."),
  ("spaceship_moncal_cruiser_name", "Mon Cal Cruiser"),
  ("spaceship_moncal_cruiser_desc", "Although smaller and not as accomodating as a Star Destroyer, ^the Mon Calamari Cruiser is as well-equipped and even faster."),  
  ("spaceship_corellian_gunship_name", "DP20 Frigate"),
  ("spaceship_corellian_gunship_desc", "The Corellian Gunship is a speedy combat warship best suited to^ hit-and-fade operations."),  
  ("spaceship_corellian_corvette_name", "CR90 Corvette"),
  ("spaceship_corellian_corvette_desc", "The Corellian Corvette is a cheap and modular support vessel^ which fares well as a combat vessel or freighter."),  
  ("spaceship_x_wing_name", "X-Wing"),
  ("spaceship_x_wing_desc", "The signature Rebel assault fighter, the X-Wing is dedicated to combat."),  
  ...
  ("spaceship_hutt_frigate_mk1_desc", "Although dated, the original Hutt Frigate is both cheap and ^versatile, making it popular with low-life pirates."),
  ("spaceship_hutt_frigate_mk2_name", "Hutt MK-2 Frigate"),
  ("spaceship_hutt_frigate_mk2_desc", "The standard MK-2 improves on the original by ^having better modularity and performance."),
  ...
  ("spaceship_z95_desc", "The z-95 Headhunter is a fast and agile craft that can run from any fight, ^although it doesn't have the resources to win one."),
...
#  ("spaceship_mercenary_raider_name", "Mercenary Raider"), <- now Wild Karrde
  ...
  ("spaceship_mercenary_raider_desc", "Modified shuttle with a spacious brig and powerful engines. A good choice for ^bountyhunters or small mercenenary groups."),  
  ...
  ("spaceship_civilian_transport_desc", "Larger and slower than most starfighters, the Civilian Transport ^is able to transport small groups of people."),
  ("spaceship_civilian_cruiser_name", "Civilian Cruiser"),
  ("spaceship_civilian_cruiser_desc", "Though it's slow, the standard Civilian Cruiser can be ^very useful as a medium transport"),  
  ("spaceship_bulk_freighter_name", "Bulk Freighter"),
  ("spaceship_bulk_freighter_desc", "Though slow and lacking everywhere else, the Bulk Freighter ^is the perfect transport for commercial purposes."),
  ...
  ("spaceship_nebulon_desc", "Although designed as an anti-starfighter ship, the ^Nebulon-B Frigate also boasts excellent troop support abilities."), 
