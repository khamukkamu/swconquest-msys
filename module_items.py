...
["wookiee_fullbody", "Wookiee Skin", [("Wookie",0)], itp_type_body_armor|itp_covers_head|itp_replaces_helm|itp_covers_legs|itp_civilian, 0, 
 530 , weight(3)|abundance(50)|head_armor(0)|body_armor(35)|leg_armor(14)|difficulty(0) ,imodbits_armor ],
...
#added unique flag so it is not left in the loot after battles, but the player can buy it from the shops if they want (nevermind, this didn't work, need to have separate items for unique vs shop)
["geonosian_armor", "Geonosian Armor", [("geonosian_armor",0)], itp_type_body_armor|itp_attach_armature|itp_covers_head|itp_covers_legs|itp_replaces_helm|itp_civilian, 0, 
 400, weight(10)|abundance(100)|head_armor(0)|body_armor(44)|leg_armor(30)|difficulty(0), imodbits_armor ], 
