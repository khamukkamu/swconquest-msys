...
dialogs = [
  ...
  ###################################################################################################
  # Autoloot: For when we just want to chat with our guys in the loot distribution screen. This needs to be at the top of the dialog menu.
  ###################################################################################################  
	[anyone,
		"start",
		[
  ...
  #SW - added dialog for talking to companions in the ship
	[anyone,
		"start",
		[
			(store_conversation_troop,"$g_talk_troop"),
			...
			(eq, "$g_camp_talk", 1),
			(eq, "$g_walk_around_ship", 1),
		],
		"All is quiet, Captain. Nothing to report.",
		"pre_member_chat",
		[]
	],
...
#Dialogue for Sarge / Captain Promotions
  ...
  [anyone|plyr, "freelancer_sarge_3",
    ...
    [ (try_begin),
        (eq, "$talk_context", tc_freelancer_infantry_captain),
        (troop_add_item, "trp_player", "itm_energy_shield_oval"),
      (else_try),
        (troop_add_item, "trp_player", "itm_energy_shield_red_large", imod_reinforced),
      (try_end)],
  ],
  ...
  [anyone|plyr, "freelancer_sarge_3",
    ...
    [
      (try_begin),
        (eq, "$talk_context", tc_freelancer_infantry_captain),
        (troop_add_item, "trp_player", "itm_vibro_sword3_gold", imod_tempered),
      (else_try),
        (troop_add_item, "trp_player", "itm_senate_rifle", imod_balanced),
      (try_end)],
  ],
  ...
  [anyone, "freelancer_cap_2",
    [(try_begin),
        ...
        (str_store_item_name, s7, "itm_heavy_repeater"),
        (str_store_string, s6, "@armour fit for a Lord, or an {s7}"),
      (else_try),
        (eq, "$talk_context", tc_freelancer_infantry_captain),
        (str_store_string, s5, "@Infantry Division Captain"),
        (str_store_item_name, s7, "itm_lightsaber_purple_2h"),
        (str_store_string, s6, "@armour fit for a Lord, or a {s7}"),
      (try_end),],
  ...
  [anyone|plyr, "freelancer_cap_3",
    ...
    [
      (try_begin),
        (eq, "$talk_context", tc_freelancer_infantry_captain),
        (troop_add_item, "trp_player", "itm_lightsaber_purple_2h", imod_balanced),
      (else_try),
        (troop_add_item, "trp_player", "itm_heavy_repeater", imod_balanced),
      (try_end)],
  ],
...
## Freelancer Event Trigger Dialogues END 
 ...
 Ships are flown by engines, you see, and engines need a crew to run them or they stop. That's where I come in.", "ramun_introduce_5",[]],
  [trp_ramun_the_slave_trader|plyr, "ramun_introduce_5", [], "Slaves.", "ramun_introduce_6",[]],
  [trp_ramun_the_slave_trader, "ramun_introduce_6", [], "Now you're catching on! A trading post like this couldn't survive without them.\
 ...
 Others are prisoners of war from various factions, brought to me because I offer the best prices.\
 ...
 You wouldn't happen to have any prisoners with you, would you?", "ramun_introduce_9",[]],
  ...
  [trp_ramun_the_slave_trader, "ramun_introduce_10", [], "Why not? If you intend to travel the Galaxy,\
 you're going to get into a shoot-out with someone sooner or later. And, hopefully, you'll come out on top.\
 Why not make some extra money off the whole thing? Take them alive, bring them back to me, and I'll pay you fifty credits for each head.\
 ...
 There's a lot of credits to be made, no mistake. More than enough for the both of us.", "close_window",[]],
 ...
 "Thanks. Perhaps I may try my hand at it.", "ramun_have_blunt_weapon_yes",[]],
  [trp_ramun_the_slave_trader,"ramun_ask_about_capturing", [],
 "Alright, I'll try and explain it again in simple terms. The basic rule of taking someone prisoner is knocking him down with a blunt weapon, like a club, or shooting him with a stun blaster\
 rather than cutting him open with a lightsaber, or blowing his head off. That way he goes to sleep for a little while rather than bleeding to death, you see?\
 It's a bit different for officers and such, they tend to be protected enough that it won't matter what kind of weapon you use,\
 ...
 And trust me, given the chance, most of the scum you run across would just as soon kill you as look at you, so don't expect any courtesy when you pull out a club instead of a vibro-weapon.\
 ...
 It's madness. How could anyone turn down all those credits, eh?", "ramun_ask_about_capturing_4",[]],
 ...
 "Thanks, I'll keep it in mind.", "ramun_pre_talk",[]],
  ...
  [trp_ramun_the_slave_trader,"ramun_leave", [], "Remember, any prisoners you've got, bring them to me. I'll pay you good credits for every one.", "close_window",[]],
...
##  [trp_tutorial_trainer, "tutorial1_4", [], "You will learn the basics of weapons and riding a speeder here.\
...
##  [party_tpl|pt_peasant,"start", [(eq,"$talk_context",tc_party_encounter)], "Greetings traveler.", "peasant_talk_1",[(play_sound,"snd_encounter_farmers")]],
...
## I wish you luck in killing them all.", "close_window",[(assign, "$g_leave_encounter",1)]],
  ...
  [party_tpl|pt_bountyhunters,"bountyhunter_talk_b1", [], "I knew it! Come on, lads, let's go get these bastards! Thanks a lot, friend.", "close_window",[(assign, "$g_leave_encounter",1)]],
...
#SW - modified jawas encounter	
  ...
  [party_tpl|pt_minorplanet_farmers,"start", [(eq,"$talk_context",tc_party_encounter),
   ...
   "Good {sir/lady}, we're only poor farmers from the planet of {s11}. {reg1?We are taking our products to sell at {s12}.:We are returning from selling our products at {s12} to our planet.}", "minorplanet_farmer_talk",
...
#SWY Added mining vessel dialogs
  ...
  [anyone|plyr,"miningvessel_talk", [], "{reg1?Ore shipment? That sounds valuable. You can either surrender the shipment to me or I'll take it by force!"
  ...
  [anyone|plyr,"miningvessel_talk", [], "{reg1?You seem busy. I'll leave you alone. Good-bye."
...
[anyone|plyr, "patrol_2", [
							...
							(store_relation,":rel", "$g_encountered_party_faction",":player_faction"),
							(le, ":rel", 0),
	], "My business is to see you dead. Nothing personal.", "close_window",[(call_script, "script_set_player_relation_with_faction", "$g_encountered_party_faction", -3),]],
[anyone|plyr, "patrol_2", [], "Just passing through. Carry on!", "close_window",[(assign, "$g_leave_encounter",1)]],

[party_tpl|pt_independent_traders,"start", [], "Hello, traveler. Are you interested in our goods, or would you perhaps like to offload some prisoners?", "independent_trader_1",[]],
[anyone|plyr, "independent_trader_1", [], "Who are you?", "independent_trader_intro_1", []],
[anyone|plyr, "independent_trader_1",[], "I'd like to sell you some of my prisoners.", "independent_trader_prisoner_1", [[change_screen_trade_prisoners]]],
[anyone, "independent_trader_prisoner_1", [], "Pleasure doing business and safe travels!", "close_window", [(assign, "$g_leave_encounter",1)]],
[anyone|plyr, "independent_trader_1",[], "Good luck in your travels.", "close_window", [(assign, "$g_leave_encounter",1)]],
[anyone, "independent_trader_intro_1", [], "We're a convoy of independent traders aligned with the Trade Federation. We mostly trade in prisoners and droids and travel around the Galaxy to pick up merchandise to transport to our home base.", "independent_trader_intro_1",[]],
[anyone|plyr, "independent_trader_intro_1",[], "Can you tell me more about the Trade Federation?", "independent_trader_intro_2", []],
[anyone, "independent_trader_intro_2", [], "Of course. The Trade Federation is an alliance of independent traders and companies who wish to remain neutral; as such, we will trade with any faction. We have several bases around the Galaxy with shipyards, slave markets and a banking system that will allow you to keep your credits safe.", "independent_trader_1", []],
[anyone|plyr, "independent_trader_intro_1",[], "Pretty soon, your head will be independent from your body. Die!", "close_window", [(call_script, "script_set_player_relation_with_faction", "$g_encountered_party_faction", -10),[encounter_attack]]],
[anyone|plyr, "independent_trader_intro_1",[], "Thank you, now about those other things...", "independent_trader_1", []],



################################################  # Duel Mod by MartinF Start ################################################ 
#SW Duel Mod - several changes made to dialogs, weapons, etc.
...
# dialog for kings. Renown requirements can be set in the module_constants file. 
  ...
  [anyone|plyr,"lord_talk_ask_something_2",[
               ...
               ], "I would like to challenge you to a friendly duel.", "king_decline_duel",[]],

  [anyone, "king_decline_duel", [], "It would hardly be fitting for somebody in my position to duel a mere soldier like yourself. Perhaps after you have distinguished yourself we can duel on friendly terms.", "lord_talk_ask_something_2",[]],
...
# dialog for lords. Renown requirements can be set in the module_constants file.
  ...
  [anyone|plyr,"lord_talk_ask_something_2",[
   ...
   [anyone,"lord_decline_duel", [], "It would hardly be fitting for somebody like me to duel a mere soldier like yourself. Perhaps after you have distinguished yourself we can duel on friendly terms.", "lord_talk_ask_something_2",[]],
...
[anyone, "lord_question_duel", [
                    ...
                    (else_try),
                     ...
                     (str_store_string, s1, "@We seem to be evenly matched, so another duel should prove to be interesting."),
                    (else_try),
...
[anyone,"duel_accept", [
        ...
        (try_begin),
           ...
           (str_store_string, s3, "@I accept your challenge.^Do you wish to fight on speeder bikes or on foot?"),
        (else_try),
 ...
 [anyone|plyr,"duel_choose_mount", [
         ...
         "I would like to duel mounted.", "duel_weap_mounted", [(str_clear, s4), (str_store_string, s4, "@speeder bikes"),]],
...
[anyone, "duel_weap_mounted", [], "What kind of weapons would you like to fight with?", "duel_weap_mounted", []],
    ...
    [anyone|plyr,"duel_weap_mounted", [],
         "Let us fight with a vibrosword and energy shield.", "duel_start", [(str_clear, s5), (str_store_string, s5, "@a vibrosword and energy shield"),
    ...
    [anyone|plyr,"duel_weap_mounted", [],
         "A duel with Mandalorian armor and ranged weapons would be my choice.", "duel_start", [(str_clear, s5), (str_store_string, s5, "@mandalorian armor and ranged weapons"),
...
#final dialog
[anyone, "duel_start", [], "Very well {playername}. ^^We will be dueling on {s4}, using {s5}.^^If this is all right, I will meet you down at the arena as soon as you finish preparing.^^NOTE:  You must press the TAB key to exit the current scene and enter the duel menu.", "duel_start", []],
...
### COMPANIONS
  ...
  [anyone|plyr,"member_castellan_talk", [],
   "I want you to abandon the garrison and join my party.", "member_castellan_join",[]],
...
#Quest heroes member chats
 ...
 Still I am sorry that I'll leave you soon. You must promise me, you'll come visit me when you can.", "close_window", []],
  ...
  [anyone ,"member_chat", [(is_between, "$g_talk_troop", pretenders_begin, pretenders_end),],
   "Greetings, {playername}, my first and foremost officer. I await your counsel.", "supported_pretender_talk", []],
  ...
  [anyone,"pretender_progress", [
   ...
   "{reg11?We have {reg11} officers on our side:We have no commander with us yet},\
 whereas {reg21?{s9} still has {reg21} officers supporting them:{s9} has no loyal officers left}.\
 {reg19?We control {reg13?{reg13} planets:} {reg14?{reg14} outposts:} {reg15?and {reg15} lesser planets:}:We don't control any outposts or planets},\
 while {reg29?they have {reg23?{reg23} planets:} {reg24?{reg24} outposts:} {reg25?and {reg25} lesser planets:}:they have no remaining planets}.\
 Overall, {s30}.", "pretender_progress_2",[]],
  ...
  [anyone|plyr,"supported_pretender_talk", [],
   "{reg65?My lady:Sir}, would you allow me to check out your equipment?", "supported_pretender_equip",[]],
...
#      (change_screen_trade)
  ...
  [anyone,"member_separate", [
      ...
      ], "Oh, really? Well, I'm not just going to wait around here. I'm going to go to other planets to look for other work. Is that what you want?", "member_separate_confirm",
   []],
  ...
  ###################################################################################################
  # Autoloot: Auto-item-loot scripts
  ###################################################################################################
	...
	[anyone,
		...
		[
			...
			(troop_get_slot,reg4,reg3,slot_upgrade_horse),
	...
	[anyone|plyr,
		...
		"member_automanage_select_melee_2",
		[
			(store_add, ":slot_num", reg1, slot_upgrade_wpn_0),
...
#	],
	...
	[anyone|plyr,
		...
		[
			(neq, reg1, 4),
			# HC - 'Pistols' option
			(store_add, ":type", 16, "str_hero_wpn_slot_none"),
			(str_store_string, s1, ":type")
		],
		"{s1}",
		"member_automanage_select_melee_2",
		[
			(store_add, ":slot_num", reg1, slot_upgrade_wpn_0),
			(troop_set_slot,reg3,":slot_num",16),
			(val_add, reg1, 1)
		]
	],
	...
	[anyone|plyr,
		...
		[
			(neq, reg1, 4),
			# HC - 'Muskets' option
			(store_add, ":type", 17, "str_hero_wpn_slot_none"),
			(str_store_string, s1, ":type")
		],
		"{s1}",
		"member_automanage_select_melee_2",
		[
			(store_add, ":slot_num", reg1, slot_upgrade_wpn_0),
			(troop_set_slot,reg3,":slot_num",17),
			(val_add, reg1, 1)
		]
	],
	...
	[anyone|plyr,
		...
		[
			(neq, reg1, 4),
			# HC - 'Ammo' option
			(store_add, ":type", 18, "str_hero_wpn_slot_none"),
			(str_store_string, s1, ":type")
		],
		"{s1}",
		"member_automanage_select_melee_2",
		[
			(store_add, ":slot_num", reg1, slot_upgrade_wpn_0),
			(troop_set_slot,reg3,":slot_num",18),
			(val_add, reg1, 1)
		]
	],
	...
	[anyone|plyr,
		...
		"Stop acquiring new transportation.",
		"member_automanage_clear_horses",
		[
			(troop_set_slot,reg3,slot_upgrade_horse,0)
		]
	],
	[anyone,
		"member_automanage_clear_horses",
		[],
		"All right. I won't acquire any transportation on my own until you tell me otherwise.",
		"member_automanage_report",
		[]
	],
	[anyone|plyr,
		...
		"Start upgrading your transportation on your own.",
	...
	[anyone,
		"member_automanage_set_horses",
		[],
		"All right. I will now upgrade to better transportation whenever I can.",
		"member_automanage_report",
		[]
	],
  ...
  [anyone|plyr,"member_question_2",[],"Do you want to play Pazaak?", "member_question_2_blackjack_1",[]],
  [anyone|plyr,"member_question_2", [], "I want to ask you something else.", "do_member_trade",[]],
  [anyone,"member_question_2_blackjack_1",[],"Sure. Are you ready to play or should I review the rules?", "member_question_2_blackjack_2",[]],
  [anyone|plyr,"member_question_2_blackjack_2",[],"Start playing.", "member_question_2_blackjack_3",[]],
  [anyone,"member_question_2_blackjack_3",
   [
    (store_troop_gold,reg1,"trp_player"),
    (ge,reg1,1),
       ],
   "Okay.^^You will have to click 'Done' to close the Party window before the game can begin.", "close_window",[
    (assign, "$black_jack",1),
    (assign, reg50, 0),
    (start_presentation, "prsnt_blackjack"),
    ]],
  [anyone,"member_question_2_blackjack_3",[],
   "You don't have enough money.", "member_question_2_blackjack_1",[]],
  [anyone|plyr,"member_question_2_blackjack_2",[],"Discuss the rules.", "member_question_2_blackjack_4",[]],
  [anyone,"member_question_2_blackjack_4",[],"Pazaak is played with the same rules as Blackjack. The player closest to 21, without going over, wins.", "member_question_2_blackjack_1",[]],
  [anyone|plyr,"member_question_2_blackjack_2",[],"Never mind.", "member_question",[]],
  ...
  [anyone,"member_background_recap_3", [
      ], "And shortly after, I joined up with you.", "do_member_trade",[]],
  ...
  [anyone, "start", [(is_between, "$g_talk_troop", companions_begin, companions_end),
   ...
   "Please do not waste any more of my time today, {sir/madam}. Perhaps we shall meet again in our travels.", "close_window", [
       ]],
  ...
  [anyone|plyr, "companion_recruit_secondchance", [
      ], "I'm sorry if I was rude earlier. What was your story again?", "companion_recruit_backstory_b", []],
...
### If the companion and the player were separated in battle
  [anyone, "start", [(is_between, "$g_talk_troop", companions_begin, companions_end),
   ...
   "It's good to see you here, {s5}! {s6}, and I didn't know whether you had been captured, killed, or in hiding. I've been roaming around since then, looking for you. Shall I get my gear together and rejoin your company?",
   "companion_rehire", [
...
###If the player and the companion parted on good terms
  [anyone, "start", [(is_between, "$g_talk_troop", companions_begin, companions_end),
   ...
   "It's good to see you, {s21}! To be honest, I had hoped to run into you.",
  ...
  [anyone|plyr|repeat_for_troops, "center_captured_lord_advice",
   [
     ...
     (try_begin),
       ...
       (str_store_string, s1, "@(no territories)"),
     (else_try),
		#SW - modified fiefs to territories
       (str_store_string, s1, "@(territories: {s0})"),
     (try_end),
     ],
  ...
  [anyone|plyr, "center_captured_lord_advice",
   [
	...
	#SW - modified fiefs to territories
   "Please {s65}, I want to have {s1} for myself. (territories: {s0})", "center_captured_lord_advice_2",
   [
  ...
  [anyone|plyr, "center_captured_lord_advice",
   [
	 ...
	 #SW - modified fiefs to territories
   "{s66}, you should have {s1} for yourself. (territories: {s0})", "center_captured_lord_advice_2",
   [
...
#     (ge, "$g_center_taken_by_player_faction", 0),
   ...
   "Hmmm. Alright, {playername}. I value your counsel highly. {reg6?I:{reg7?You:{s11}}} will be the new {reg3?lady:officer} of {s1}.", "close_window",
   [
...
## The companion explains his/her reasons for quitting
  ...
  [anyone|plyr, "companion_quitting_response", [
      ...
      ], "Maybe I can convince you to stay.", "companion_quitting_persuasion", [
            (assign, "$player_can_persuade_npc", 0),
          ]],
  ...
  [anyone|plyr, "companion_quitting_response", [
      ...
      ], "I'm afraid I cannot allow that to happen. If you try to leave, I'll have to kill you.", "companion_quitting_no", [
          ]],

  [anyone, "companion_quitting_no", [],
   "You... wouldn't dare. I thought we were friends, {playername}.", "companion_quitting_no_confirm", [
       ]],

  [anyone|plyr, "companion_quitting_no_confirm", [],
   "Don't doubt it. You'll either listen to orders, or have a blaster bolt in the back... your choice.", "companion_quitting_no_confirmed", [
       ]],

  [anyone|plyr, "companion_quitting_no_confirm", [],
   "You're right, of course... I don't know what came over me, but it's not right to keep you here. You may go, my friend.", "companion_quitting_yes", [
       ]],
  ...
  [anyone, "companion_quitting_no_confirmed", [
   ...
   "My liberty or my life. Then, it seems I have no choice but to stay and serve you, {playername}.", "close_window", [
       ]],
...
#Morality objections
  ...
  [anyone|plyr, "companion_objection_response", [
      ...
      ], "We can only hope it won't happen again.", "close_window", [
                    (troop_set_slot, "$map_talk_troop", "$npc_grievance_slot", tms_acknowledged),
          ]],
...
# Personality clash 2 objections
  ...
  [anyone|plyr, "companion_personalityclash2_response", [
      ...
      ],  "Tell {s11} you have my support in this, and that {reg11?she:he} should hold {reg11?her:his} tongue.", "close_window", [
...
##          ]],
  ...
  [anyone|plyr, "companion_home_description", [
      ],  "We don't have time to chat right now.", "close_window", [
          ]],
 ...
 And of course, you will always remain as my foremost commander."),
  ...
  [anyone,"rebel_thanks_answer_2", [], "asdf", "close_window", []],
...
# Faction Lords:
  ...
  [anyone|plyr,"player_siege_spacestation_commander_1", [],
   "Surrender now! Your shields won't hold, and your troops will not survive our siege! Your situation is hopeless!", "player_siege_ask_surrender", []],
  ...
  [anyone,"player_siege_ask_surrender", [(lt, "$g_enemy_strength", 200), (store_mul,":required_str","$g_enemy_strength",3),(ge, "$g_ally_strength", ":required_str")],
   "We... are ready to leave this place, if you give your word you will not fire upon us.", "player_siege_ask_leave_unmolested", []],
  [anyone,"player_siege_ask_surrender", [],
   "Surely you are joking? You cannot hope to defeat us. We'll die fighting before surrendering to you!", "close_window", []],

  
  [anyone|plyr,"player_siege_ask_surrender_treatment", [],
   "I'll give you nothing. Surrender now or be destroyed!", "player_siege_ask_surrender_treatment_reject", []],
  [anyone,"player_siege_ask_surrender_treatment_reject", [],
   "I should have known better than to bargain with scum like you. All hands, man your battlestations. We won't go without a fight!", "close_window", []],
  [anyone|plyr,"player_siege_ask_surrender_treatment", [],
  ...
  [anyone,"player_siege_ask_leave_unmolested_accept", [],
   "Very well. Then we leave this place to you. You have won this day. But we'll meet again.", "close_window", [(assign,"$g_spacestation_left_to_player",1)]],
  [anyone|plyr,"player_siege_ask_leave_unmolested", [],
  ...
  [anyone,"player_siege_ask_leave_unmolested_reject", [],
   "Then these negotiations are over. All hands, man battlestations! If it's a fight they want it's a fight they'll get.", "close_window", []],
...
#After battle texts
  ...
  [anyone,"start", [(eq, "$talk_context", tc_hero_freed),
   ...
   "I am in your debt for freeing me from that scum-infested place, thank you.", "freed_lord_answer",
   [
    (call_script, "script_remove_troop_from_prison", "$g_talk_troop"),
   ]],

  [anyone|plyr,"freed_lord_answer", [(lt, "$g_talk_troop_faction_relation", 0)],
   "Ha! I'm afraid you're not going anywhere. Take them away.", "freed_lord_answer_1",
  ...
  [anyone,"freed_lord_answer_1", [],
   "Someday, you'll pay for this.", "close_window", []],

  [anyone|plyr,"freed_lord_answer", [],
   "You're free to go on your way, friend", "freed_lord_answer_2",
...
##                                     (hero_can_join)],
##   "I need capable troops like you. Would you like to join me?", "knight_offer_join",
##   []],
##
...
#Troop commentary changes begin
  ...
  [anyone|plyr,"defeat_lord_answer", [],
   "You are my prisoner now. I imagine your superiors will offer me a hefty price for your ransom.", "defeat_lord_answer_1",
   [
     #(troop_set_slot, "$g_talk_troop", slot_troop_is_prisoner, 1),
     (troop_set_slot, "$g_talk_troop", slot_troop_prisoner_of_party, "p_main_party"),
  ...
  [anyone,"defeat_lord_answer_1", [],
   "Blast... I'll go along, for now. I have friends in high places. You'll regret this.", "close_window", []],

  [anyone|plyr,"defeat_lord_answer", [],
   "You have fought with honor. You may go free.", "defeat_lord_answer_2",
...
#TODO: Add adition conditions, lord personalities, battle advantage, etc...                                                
   ...
   "I owe you a favor, don't I. Well... alright, then. I'll let you go-- but just this once!", "close_window", [
    (call_script, "script_change_player_relation_with_troop","$g_talk_troop", -7),
  ...
  [anyone, "party_encounter_offer_dont_fight", [
   ...
   "Ha! But I want to fight you! All hands, battlestations!", "close_window", []],
...
##                     ],
##   "I had trusted that datacard to you, thinking you were a {man/lady} of honor, and you handed it directly to the girl's father.\
...
#Rebellion changes begin
  ...
  [anyone ,"start",
   ...
   "[Our first task is to seize a planet. Then other commanders will join us.]", "pretender_start", [
     ]],
 ...
 The lords of our empire have all sworn to be allies of {s11}.\
 Such allegiances are that of madness, and surely we can count on the support of some... but a difficult road lies ahead.", "pretender_discuss_rebellion_2", []],
 ...
 But no, thanks. I will not be part of your game.", "close_window", []],
  ...
  [anyone ,"pretender_discuss_rebellion_3", [(gt, "$players_faction", 0),
   ...
   "{playername}, you are already allied to serve {s15}.\
 As such, I cannot allow you to take up my cause, and let my enemies claim that I am but a mere puppet of {s16}.\
 No, if I am to be the leader of {s17}, I must do it due to the righteousness of my cause and the support of my allies alone.\
 If you want to help me, you must first free yourself of your allegiance to {s15}.", "close_window", []],

  [anyone ,"pretender_discuss_rebellion_3", [(troop_get_slot, ":original_faction", "$g_talk_troop", slot_troop_original_faction),
                                             (str_store_faction_name, s12, ":original_faction"),
                                             (faction_get_slot, ":original_ruler", ":original_faction", slot_faction_leader),
                                             (str_store_troop_name, s11, ":original_ruler")],
   "You are a capable warrior, {playername}, and I am sure with your renown as a commander, and my cause, the rulers and the good people of {s12} will flock to our support.\
 ...
 But first, you must give me your allegiance and accept me as your leader {reg65?lady:lord}.", "pretender_rebellion_ready", []],
...
#Check to see if support base is captured or under siege
   ...
   "[Before we rebel, I want you to raise support for my cause. I have always had strong backing from the planet of {s4}, but you may have good ties in other places. Are you up for that?]", "pretender_town_quest", [
  ...
  [anyone ,"pretender_discuss_rebellion", [(is_between, "$g_talk_troop", pretenders_begin, pretenders_end),
   ...
   "[Before we rebel, I want you to raise support for my cause. If you have good ties with any planets, you should try there. Are you up for that?]", "pretender_town_quest", [
     ]],
  ...
  [anyone ,"pretender_discuss_rebellion", [(is_between, "$g_talk_troop", pretenders_begin, pretenders_end),
                     (gt, "$town_to_rebel", 0),
                     ],   "You have done good work. {s4} and possibly other planets are ready to rebel. Whenever you are ready, let us start the war.", "pretender_rebellion_ready", [
  ...
  [anyone ,"lord_give_conclude_2", [(is_between, "$g_talk_troop", pretenders_begin, pretenders_end),
   ...
   "Forward, then! Our first task is to take hold of a system and persuade other lords to join us. You lead the way!", "close_window", [
...
##            (call_script, "script_player_join_faction", "$g_talk_troop_faction"),
  ...
  [anyone ,"pretender_end", [
   ...
   "Good-bye for now, then.", "close_window", [
     ]],
...
#Post 0907 changes begin
 ...
 you should end all contact with that person.", "lord_event_choose_friend", [
  ...
  [anyone ,"lord_event_choose_friend_renounce", [],  "Good news, {playername}. I would fear for your safety otherwise.\
 If you do encounter {s6}, keep your blaster at your side and don't believe a word.", "lord_pretalk", []],
  
  [anyone|plyr ,"lord_event_choose_friend", [],  "{s6} is a good person, you've no right to speak of them that way.", "lord_event_choose_friend_defend", [
      (call_script, "script_change_player_relation_with_troop","$g_talk_troop",-10),
      (call_script, "script_change_player_relation_with_troop","$temp",5),
      ]],
  [anyone ,"lord_event_choose_friend_defend", [],  "As you like, {playername}.\
 You may be a fool, but at least you are an loyal fool. {s6}'s loyalty may not be so steadfast, however...", "lord_pretalk", []],
#Post 0907 changes end
  ...
  [anyone ,"lord_event_choose_friend_neutral", [],  "As you wish, {playername}.\
 Remember, everyone in the Galaxy needs friends. Stand alone and you shall never find any.", "lord_pretalk", []],
...
#Meeting.
  ...
  [anyone ,"start", [(troop_slot_eq,"$g_talk_troop",slot_troop_occupation, slto_faction_hero),
   ...
   "{playername}, I've been expecting you.\
 I keep reading reports of your leadership and bravery in my databank and my mind was quickly made up.\
 I knew that I had found someone worthy of becoming one of my commanders.", "lord_invite_1",
   []],


  [anyone|plyr ,"lord_invite_1", [],  "Thank you, {s65}, you honor me with your favor.", "lord_invite_2",  []],
  [anyone|plyr ,"lord_invite_1", [],  "It is good to have my true value recognized.", "lord_invite_2",  []],
   
  [anyone ,"lord_invite_2", [],  "Indeed. Let us dispense with the formalities, {playername}; are you ready to swear loyalty to me?", "lord_invite_3",  []],
...
#                     (str_store_faction_name, s4,  "$players_faction"),
  ...
  [anyone|plyr ,"lord_meet_enemy", [],  "They know me as {playername}. Mark it down, you shall be hearing a lot about me.", "lord_intro", []],
#  [anyone, "lord_meet_enemy_2", [],  "{playername} eh? Never heard of you. What do you want?", "lord_talk", []],
...
##   "TODO: You have brought the prisoners and received {reg1} credits. Give me the money now.", "lord_bring_prisoners_complete_2",[]],
##
##  [anyone,"lord_start", [(troop_slot_eq, "$g_talk_troop", slot_troop_is_prisoner, 0),
##                         (store_partner_quest,":lords_quest"),
##                         (eq,":lords_quest","qst_bring_prisoners_to_enemy"),
...
##                         (quest_get_slot, ":quest_target_amount", "qst_bring_prisoners_to_enemy", slot_quest_target_amount),
##                         (assign, reg1, ":quest_target_amount")],
##   "TODO: You have brought the prisoners but some of them died during your expedition. Give me the full money of {reg1} credits.", "lord_bring_prisoners_complete_2",[]],
##
##
...
##
 ...
 The fool has lost one of their most valuable allies, and we are one step closer to bringing their destruction.\
 Here, this credit chip contains {reg5} credits, and I want you to have it. You deserve every one.\
 ...
 But no, you were too damned honorable, weren't you?", "close_window",[
  ...
  [anyone, "quest_meet_spy_in_enemy_town_completed_2", [],
   "Ahh, well done. It's good to have competent {troops/people} on my side. Here is the payment I promised you.", "lord_pretalk",
   [
  ...
  [anyone,"lord_start", [(store_partner_quest,":lords_quest"),
   ...
   "Brilliant work, {playername}! Your convoy raids really got their attention, I must say.\
 ...
 And by that I of course mean taking and plundering {s13} star systems!\
 ...
 What the hell made you think that getting yourself captured while trying to start a war was a good idea?\
 ...
 Oh, be assured that I will not.", "lord_pretalk",
  ...
  [anyone,"lord_start", [(store_partner_quest,":lords_quest"),
   ...
   "I'm told that you've collected the money owed me from {s7}. Good, it's about time I had it back.\
 I believe I promised to give you one-fifth of it all, eh?\
 Well, that makes {reg3} credits, so if you give me my share -- that's {reg4} credits -- you can keep the rest.", "lord_collect_debt_completed", []],

  
  [anyone|plyr,"lord_collect_debt_completed", [(store_troop_gold, ":gold", "trp_player"),
                                               (ge, ":gold", reg4)],
   "Of course, {s65}. {reg4} credits, all here.", "lord_collect_debt_pay",[]],
 ...
 I know full well that {s7} gave you the money, and I want every credit owed to me, {sir/madam}.\
 As far as I'm concerned, I hold you personally in my debt until I see the credits.", "close_window",[
  ...
  [anyone,"lord_start", [(store_partner_quest,":lords_quest"),
   ...
   "I heard you got rid of that blasted merchant that was causing me so much grief.\
 ...
 Here's your reward. Remember, {playername}, stick with me and we'll go a long, long way together.", "close_window",
  ...
  [anyone,"lord_start", [(store_partner_quest,":lords_quest"),
   ...
   "Oh, it's you. Enlighten me, how exactly does one lose a simple fight to some merchant?\
 ...
 Just leave me be, {playername}, I have things to do.", "close_window",
  ...
  [anyone,"lord_start", [(store_partner_quest,":lords_quest"),
   ...
   "You! Do you have vacuum between your ears? Did you think that when I said to kill the merchant,\
 I meant you to have a nice chat with him and then let him go?! What were you thinking?", "lord_kill_local_merchant_let_go",[]],

  [anyone|plyr,"lord_kill_local_merchant_let_go", [],
   "I made sure he will not act against you.", "lord_kill_local_merchant_let_go_2",[]],

  [anyone,"lord_kill_local_merchant_let_go_2", [],
   "Idiot! You were supposed to remove him, not give him a reprimand and send him on his way.\
 He'd better do as you say, or you'll both regret it.\
 Here, this is half the credits I promised you. Don't say a word, {playername}, you're lucky to get even that.\
 I have little use for {troops/people} who cannot follow orders.", "lord_pretalk",
...
##  [anyone|plyr,"quest_hunt_down_raiders_failed", [],  "They were too quick for us sir. But next time we'll get them", "quest_hunt_down_raiders_failed_2",[]],
##  [anyone|plyr,"quest_hunt_down_raiders_failed", [],  "They were too strong and well armed sir. But we'll be ready for them next time.", "quest_hunt_down_raiders_failed_2",[]],
##  
...
##   "TODO: You have saved all of them. Good job.", "lord_generic_mission_completed",
...
##   "TODO: You have saved some of them. Good effort.", "lord_capture_conspirators_half_completed",
##   [(party_remove_members, "p_main_party", "trp_noble_refugee", "$qst_defend_nobles_against_peasants_num_nobles_saved"),
##    (party_remove_members, "p_main_party", "trp_noble_refugee_woman", "$qst_defend_nobles_against_peasants_num_nobles_saved"),
##    (assign, ":ratio", 100),
...
##                         (val_add, ":num_saved", ":num_nobles"),
##                         (eq, ":num_saved", 0)],
##   "TODO: You have saved none of them. I guess you did what you could.", "lord_generic_mission_failed", []],
##
##
##  [anyone,"lord_start", [(troop_slot_eq, "$g_talk_troop", slot_troop_is_prisoner, 0),
##                         (store_partner_quest,":lords_quest"),
...
##   "TODO: You have captured all of them. Good job.", "lord_generic_mission_completed",
...
##                         (gt, ":sum_captured", 0)],
##   "TODO: You have captured some of them. Well done.", "lord_capture_conspirators_half_completed",
...
##                         (store_add, ":sum_captured", ":num_conspirators", ":num_conspirator_leaders"),
##                         (eq, ":sum_captured", 0)],
##   "TODO: You have captured none of them. You have failed me.", "lord_generic_mission_failed", []],
##
...
##   "TODO: That's all I can do.", "lord_pretalk", []],
 ...
 and the pair are now safely caged in my prison, waiting to be questioned.\
 My interrogators will certainly be busy tonight! Anyway, I'm very pleased with your success, {playername}, and I give you\
 this credit chip as a token of my appreciation.", "lord_follow_spy_completed",
 ...
 whatever master he served. It's better than nothing.\
 ...
 Forget any reward I offered you. You've done nothing to earn it.", "lord_follow_spy_failed",
  ...
  [anyone,"lord_start", [(store_partner_quest,":lords_quest"),
   ...
   "Damn me, but you've done it, {playername}. All the servants are back and they're busy preparing for the harvest.\
 You certainly earned your reward. Here, take it, with my compliments.", "lord_generic_mission_completed",
  ...
  [anyone,"lord_start", [(store_partner_quest,":lords_quest"),
   ...
   "{playername}. I have been waiting patiently for my servants, yet none have returned. Have you an explanation?\
 Were you outwitted by simple servants, or are you merely incompetent?\
 Or perhaps you are plotting with my enemies, intending to ruin me...", "lord_bring_back_runaway_serfs_failed", []],
  [anyone|plyr,"lord_bring_back_runaway_serfs_failed", [],
   "Forgive me, {s65}, those servants were as slippery as a smuggler.", "lord_bring_back_runaway_serfs_failed_1a", []],
  [anyone|plyr,"lord_bring_back_runaway_serfs_failed", [],
  ...
  [anyone,"lord_bring_back_runaway_serfs_failed_1a", [],
   "That is hardly an excuse for failure, {playername}.\
 Now, if you will excuse me, I need to recruit new servants to work these fields before we all starve.", "lord_pretalk",
   [(call_script, "script_change_player_relation_with_troop","$g_talk_troop",-1),
    (call_script, "script_end_quest", "qst_bring_back_runaway_serfs")]],
  ...
  [anyone,"lord_start", [(store_partner_quest,":lords_quest"),
   ...
   "You disappoint me, {playername}. There were 3 groups of servants that I charged you to return. 3. Not {reg17}.\
 I suppose the ones who did come back shall have to work twice as hard to make up for those that got away.\
 As for your reward, {playername}, I'll only pay you for the servants you returned, not the ones you let escape.\
 Here. Take it, and let this business be done.", "lord_runaway_serf_half_completed",
  ...
  [anyone,"lord_start", [(store_partner_quest,":lords_quest"),
   ...
   "{playername}, I was told that you have crushed the pirates at the planet of {s5}. Please know that I am most grateful to you for that.\
 Please, let me pay the expenses of your campaign. Here, I hope these {reg14} credits will be adequate.", "lord_deal_with_bandits_completed",
   [
       (call_script, "script_change_player_relation_with_troop", "$g_talk_troop", 3),
       (store_character_level, ":level", "trp_player"),
  ...
  [anyone,"lord_start", [(store_partner_quest,":lords_quest"),
   ...
   "Damn it, {playername}. I heard that you were unable to drive off the bandits from the planet of {s5}, and thanks to you, part of the planet now lies in ruins.\
 Everyone said that you were a capable warrior, but apparently, they were wrong.", "lord_pretalk",
  ...
  [anyone,"lord_start", [(store_partner_quest,":lords_quest"),
   ...
   "Ah, {playername}. My quartermaster has informed me of your delivery, a herd of {reg13} nerfs, as I requested. I'm impressed.", "lord_deliver_cattle_to_army_thank",
   [
     (call_script, "script_change_player_relation_with_troop", "$g_talk_troop", 2),
  ...
  [anyone,"lord_start", [(store_partner_quest,":lords_quest"),
   ...
   "You make a good scout, {playername}. My aide just brought me your reports of the mission to {s13}, {s14} and {s15}. Well done.", "lord_scout_waypoints_thank",
   [
     #TODO: Change reward
     (call_script, "script_change_player_relation_with_troop", "$g_talk_troop", 1),
#     (call_script, "script_troop_add_gold", "trp_player", 100),
     ...
     (try_begin),
       ...
       (str_store_troop_name_link, s9, "$g_talk_troop"),
       (setup_quest_text, "qst_follow_army"),
       (str_store_string, s2, "@Your mission is complete, {s9} wants you to resume following his fleet until further notice."),
       (call_script, "script_start_quest", "qst_follow_army", "$g_talk_troop"),
       (assign, "$g_player_follow_army_warnings", 0),
     (try_end),
     ]],
  ...
  [anyone, "lord_start",
   ...
   "The fleet's supplies are dwindling too quickly, {playername}. I need you to bring me a herd of {reg3} nerfs so I can keep the troops fed. I care very little about where you get them, just bring them to me as soon as you can.", "lord_mission_told_deliver_cattle_to_army",
   [
   ]
   ],

  [anyone|plyr,"lord_mission_told_deliver_cattle_to_army", [], "Very well, I can find you some nerfs.", "lord_mission_told_deliver_cattle_to_army_accepted",[]],
  ...
  [anyone,"lord_mission_told_deliver_cattle_to_army_accepted", [], "Excellent! You know what to do, {playername}, now get to it. I need those nerfs sooner rather than later.", "close_window",
   [
     ...
     (str_store_string, s2, "@{s13} asked you to gather a herd of {reg3} nerfs and deliver them back to them."),
...
##    (try_begin),
##      (is_between, "$g_encountered_party", centers_begin, centers_end),#Lord might be in space
...
##### TODO: QUESTS COMMENT OUT END
  ...
  [anyone|plyr,"lord_generic_mission_completed", [],
   "It was an honor to serve.", "lord_pretalk",[]],
...
##    ]],
  ...
  [anyone,"lord_start", [#(troop_slot_eq, "$g_talk_troop", slot_troop_is_prisoner, 0),
   ...
   "I think you owe me {reg1} credits, {playername}. Do you intend to pay your debt anytime soon?", "lord_pay_debt_2",[]],

  [anyone|plyr, "lord_pay_debt_2", [(troop_get_slot, ":cur_debt", "$g_talk_troop", slot_troop_player_debt),
                                    (store_troop_gold, ":cur_gold", "trp_player"),
                                    (le, ":cur_debt", ":cur_gold")],
   "That is why I came, {s65}. Here it is, every credit I owe you.", "lord_pay_debt_3_1", [(troop_get_slot, ":cur_debt", "$g_talk_troop", slot_troop_player_debt),
...
## But we need to decide what to do with this new planet now.", "lord_claim_center_begin", []],
...
## as a person of low rank and status you cannot be permitted to hold that system for yourself.\
## It is to your benefit to sell it to a commander like myself who can hold and protect the battlestation and the surrounding planets.\
## Anyway, I am ready to make you an offer of 5000 credits, should you decide to sell the planet.", "lord_buy_center", []],
##
##
##  [anyone|plyr,"lord_buy_center", [],
##   "I accept your offer sir. The system is yours for 5000 credits.", "lord_buy_center_accept", []],
##  [anyone|plyr,"lord_buy_center", [],
...
## Why bother yourself with the necessities of holding a planet when you can leave all those boring details to governors like me?\
## I am sure money will be much more useful to you than a battlestation would.", "lord_buy_center_accept_2", []],
##
##  [anyone|plyr,"lord_buy_center_accept_2", [],
##   "One day sir, one day I'll have my own system.", "lord_buy_center_accept_3", []],
##  [anyone|plyr,"lord_buy_center_accept_2", [],
##   "Everyone needs money sir. I can take another planet anytime.", "lord_buy_center_accept_3", []],
##
##  [anyone,"lord_buy_center_accept_3", [],
##   "Of course, of course, {playername}.  Then let us conclude our deal. Here's the 5000 credits I offered you.\
...
##   "As you wish {playername}. But don't forget, the great commanders of the Galaxy won't like a random {man/woman} like you holding such a system without their consent.\
## It is the nature of this Galaxy {playername}. Everyone should know their place.", "lord_pretalk", []],
  ...
  [anyone,"lord_start", [(party_slot_eq, "$g_encountered_party",slot_mainplanet_lord, "$g_talk_troop"),#we are talking to Town's Lord.
   ...
   "I heard that you have captured our enemy {s3} and they are with you at the moment.\
 I can pay you {reg6} credits for them right now.\
 You can wait for their friends to pay the ransom, of course, but there is no telling how long that will take, eh?\
", "lord_buy_prisoner", []],

  [anyone|plyr,"lord_buy_prisoner", [],
   "I accept your offer. I'll leave {s3} to you for {reg6} credits.", "lord_buy_prisoner_accept", []],
  [anyone|plyr,"lord_buy_prisoner", [],
   "I fear I can't accept your offer.", "lord_buy_prisoner_deny", [(assign, "$g_ransom_offer_rejected", 1),]],

  [anyone,"lord_buy_prisoner_accept", [],
   "Excellent! Here's your {reg6} credits.\
 I'll send some troops to take them to our prison with due haste.", "lord_pretalk", [
  ...
  [anyone,"lord_buy_prisoner_deny", [],
   "Mmm. As you wish, {playername}, but you'll not get a better offer. Take my word for it.", "lord_pretalk", []],
...
##### TODO: QUESTS COMMENT OUT BEGIN
  ...
  [anyone|plyr,"lord_talk",[#(troop_slot_eq, "$g_talk_troop", slot_troop_is_prisoner, 0),
   ...
   "I'd like {s14} returned to me, {s65}, if you're quite finished with his {reg3?her:his} services.", "lord_lend_companion_end",
   []],

  [anyone,"lord_lend_companion_end",[(neg|hero_can_join, "p_main_party")],
   "You've too many troops aboard your ship already, {playername}. You cannot possibly accommodate more at the moment.", "lord_pretalk",
   []],

  [anyone,"lord_lend_companion_end",[],
   "Of course, {playername}. {reg3?She:He} is a bright {reg3?girl:fellow}, you're a lucky {man/woman} to have such worthy companions.", "lord_pretalk",
   [(quest_get_slot, ":quest_target_troop", "qst_lend_companion", slot_quest_target_troop),
 ...
 Thank you for accepting to take the money to them.\
 Please give them these {reg10} credits and thank them on my behalf.", "close_window",
...
##     ]],
##
##  [anyone,"lord_reinforcement_brought", [], "Well done {playername}. These troops will no doubt be very useful. I will speak to {s1} of your help.", "lord_pretalk",[]],
...
##
 ...
 Everyone knows that she beds her guards and anyone else she can lay hands on while her husband is away.\
 I merely repeat the words of many.", "lord_challenge_duel_for_lady_2",[]],
  [anyone|plyr,"lord_challenge_duel_for_lady_2", [], "You will take back these lies, or prove them against my blaster!", "lord_challenge_duel_for_lady_3",[]],
 ...
 and give my regards to {s9} when you see them again.", "lord_pretalk",[
 ...
 Perhaps one day I will be able to repay you.", "lord_deliver_message_prisoner_2",[]],
  [anyone|plyr,"lord_deliver_message_prisoner_2", [], " 'It was the least I could do, {s65}.", "lord_deliver_message_prisoner_2a",[]],
  ...
  [anyone|plyr,"lord_talk", [#(troop_slot_eq, "$g_talk_troop", slot_troop_is_prisoner, 1),
   ...
   "Don't fret, I am here to rescue you.", "lord_rescue_by_replace_offer",[]],
  [anyone,"lord_rescue_by_replace_offer", [],
   "Are you serious? What is your plan?", "lord_rescue_by_replace_offer_2",[]],
 ...
 I paid the guards a handsome bribe, with which I am sure they have already purchased half the wine stocks of the nearest cantina.\
 With some luck they'll soon get so drunk they'd have trouble\
 recognizing their own mothers, let alone telling one of us from the other.\
 ...
 and perhaps I shall be able to repay the debt I owe you.", "lord_rescue_by_replace_offer_6",[]],
  [anyone|plyr,"lord_rescue_by_replace_offer_6",[],
   "Quickly, {s65}, let us exchange garments. It's time for you to leave.", "close_window",
...
##   "Sir, {s3} asked me to give this datacard to your daughter, but I think you should read it first.", "lord_deliver_message_to_lover_tell_father",[]],
##
##  [anyone,"lord_deliver_message_to_lover_tell_father", [],
##   "That swine called {s3} is trying to approach my daughter eh? You have made the right decision by bringing this datacard to me. I'll have a long talk with {s4} about it.", "lord_pretalk",
...
##   "Of course {playername}. You are welcome here. You may rest at {s1} as long as you wish.", "close_window",[(assign, "$g_permitted_to_center",1)]],
  ...
  [anyone|plyr,"lord_talk", [#(troop_slot_eq, "$g_talk_troop", slot_troop_is_prisoner, 0),
   ...
   "{s66}, I wish to restore my allegiance to {s4}.", "lord_ask_pardon_after_oath_renounced",[]],
  ...
  [anyone,"lord_ask_pardon_after_oath_renounced",
   [
     ...
     ], "That is too great a matter for me to decide, {playername}. You should seek out {s4}. Such clemency is theirs alone to grant or deny.", "lord_pretalk",[]],
   ...
   [
     ...
     (try_begin),
       ...
       (try_begin),
         ...
         (str_store_string, s11, "@Very well, I will accept you back into my ranks, if you're ready to swear your allegiance once more."),
         (assign, "$players_oath_renounced_terms_state", 1),
       (else_try),
         (str_store_string, s11, "@A pardon will only be possible if you are willing to surrender {s17} to me. Do you agree my terms?"),
  ...
  [anyone|plyr,"lord_ask_pardon_terms",
   ...
   "Yes, I am ready.", "lord_ask_pardon_after_renounce_peace",[]],
  ...
  [anyone|plyr,"lord_ask_pardon_terms",
   ...
   "Yes, I agree to those terms.", "lord_ask_pardon_after_renounce_peace",[]],
  ...
  [anyone,"lord_ask_pardon_after_renounce_peace",
   [], "Excellent. Though you strayed from us, {playername}, what is most important is that you have found your way back to the right path. I hereby restore your planets and you are once more an honored {man/warrior} in my service.", "lord_pretalk",
   [
     (try_for_range, ":cur_center", walled_centers_begin, walled_centers_end),
       (store_faction_of_party, ":cur_center_faction", ":cur_center"),
       (eq, ":cur_center_faction", "fac_player_supporters_faction"),
  ...
  [anyone,"lord_ask_pardon_terms_rejected",
   [], "Then get out of my sight, traitor! Leave, and do not come back!", "close_window",
   [
     (assign, "$g_leave_encounter", 1),
  ...
  [anyone,"lord_ask_pardon", [(lt, "$g_talk_troop_relation", -10)], "Do you indeed, {playername}? Then go and trip on your vibro-sword. Give us all peace.", "lord_pretalk",[]],
 ...
 but there are some who see you as an enemy and will not be satisfied unless you pay many credits to compensate your actions.\
 All in all, you'd need to bring no less than {reg16} credits to make any friends in {s4}.", "lord_ask_pardon_2",[]],

  [anyone|plyr,"lord_ask_pardon_2", [(store_troop_gold, ":gold","trp_player"),(ge, ":gold", reg16)], "I have the money here. {reg16} credits.", "lord_ask_pardon_tribue_accept",[]],
 ...
 I'll use these credits to smooth the feathers of those who may oppose your pardon, and I'm sure that word will soon spread that you are no longer an enemy of {s4}.", "close_window",
   [
  ...
  [anyone,"lord_ask_pardon_tribue_deny", [], "Then there's nothing I can do for you, {playername}. Without those credits, your status can never be restored.", "lord_pretalk",[]],
  ...
  [anyone,"lord_pay_mercenary", [(assign, reg8, "$mercenary_service_accumulated_pay")],
   "Hmm, let me see... according to my ledgers, we owe you {reg8} credits for your work. Here you are.", "lord_pay_mercenary_2",
...
#                             (eq,"$g_talk_troop_faction","$players_faction")
  ...
  [anyone|plyr,"lord_talk", [(le,"$talk_context", tc_party_encounter),
   ...
   "{s66}, I wish to become your ally and fight for your cause.", "lord_ask_enter_service",[]],
  ...
  [anyone|plyr,"lord_talk", [(le,"$talk_context", tc_party_encounter),
   ...
   "{s66}, I wish to be released from my allegiance to you.", "lord_ask_leave_service",[]],
...
##   "TODO2:I want to fight alongside you against your enemies.", "close_window",[]],
  ...
  [anyone|plyr,"lord_give_order", [],
  #SW - modified dialog
   "Raid around the planet of...", "lord_give_order_details_ask",
   [
...
[anyone,"lord_give_order_assault", [
  ...
  [anyone,"lord_give_order_stop",
   [],
   "Alright. I will do that.", "lord_pretalk",
   [
  ...
  [anyone|plyr,"lord_talk",
   ...
   "I want to start a new campaign. Let us assemble our forces here.", "lord_give_order_call_to_arms_verify",
   []],

  [anyone,"lord_give_order_call_to_arms_verify", [],
   "You wish to summon all commanders for a new campaign?", "lord_give_order_call_to_arms_verify_2",[]],
  ...
  [anyone,"lord_give_order_disband_army",
   [],
   "Alright. I will let everyone know that they are released from duty.", "lord_pretalk",
   [
  ...
  [anyone,"lord_talk_ask_something", [],
   "Yes? What is it?", "lord_talk_ask_something_2",[]],
  ...
  [anyone|plyr,"lord_talk_ask_something_2", [],
   "What are you and your troops doing?", "lord_tell_objective",[]],
  ...
  #SW - new functionality for BLACKJACK MOD when talking to troops
  [anyone|plyr,"lord_talk_ask_something_2",[],"Do you want to play Pazaak?", "lord_blackjack_1",[]],
  [anyone,"lord_blackjack_1",[],"Sure. Are you ready to play or should I review the rules?", "lord_blackjack_2",[]],
  [anyone|plyr,"lord_blackjack_2",[],"Start playing.", "lord_blackjack_3",[]],
  [anyone,"lord_blackjack_3",
   [
    (store_troop_gold,reg1,"trp_player"),
    (ge,reg1,1),
       ],
   "Okay.^^You may need to move your character to one side so the 'Talk' dialog does not appear while playing the game.", "close_window",[
    (assign, "$black_jack",1),
    (assign, reg50, 0),
    (start_presentation, "prsnt_blackjack"),
    ]],
  [anyone,"lord_blackjack_3",[],
   "You don't have enough money.", "lord_blackjack_1",[]],
  [anyone|plyr,"lord_blackjack_2",[],"Discuss the rules.", "lord_blackjack_4",[]],
  [anyone,"lord_blackjack_4",[],"Pazaak is played with the same rules as Blackjack. The player closest to 21, without going over, wins.", "lord_blackjack_1",[]],
  [anyone|plyr,"lord_blackjack_2",[],"Never mind.", "lord_talk_ask_something",[]],
  # end of blackjack mod  
  ...
  [anyone,"lord_talk_ask_location", [],
   "Very well, but I may or may not have an answer for you. About whom do you wish to hear?", "lord_talk_ask_location_2",[]],
  ...
  [anyone|plyr,"lord_talk", [(eq,"$talk_context",tc_party_encounter),
                             (lt, "$g_encountered_party_relation", 0),
                             (str_store_troop_name,s4,"$g_talk_troop")],
   "I say this only once, {s4}! Surrender or prepare to fight!", "party_encounter_lord_hostile_ultimatum_surrender", []],
...
##   "I wish to ask for a favor.", "lord_ask_for_favor_ask",[]],
  ...
  [anyone,"liege_defends_claim_1", [],
   "Oh, really? I've not met many people who would dare mention that name around me. I am not sure whether to reward your bravery, or punish you for your impudence.", "liege_defends_claim_2", [
...
], "Hmm. Do you perhaps tell each commander something different, depending on what you think they most want to hear?", "lord_join_rebellion_suggest_4",
[
...
#Rebellion changes end
  ...
  [anyone,"lord_tell_objective", [(troop_slot_eq, "$g_talk_troop", slot_troop_leaded_party, -1)],
   "I am not commanding any troops at the moment.", "lord_pretalk",[]],
  ...
  [anyone,"lord_tell_objective", [(party_slot_eq, "$g_talk_troop_party", slot_party_ai_state, spai_holding_center)],
   "We are traveling to {s1}.", "lord_pretalk",[(party_get_slot, ":ai_object", "$g_talk_troop_party", slot_party_ai_object),
                                                 (str_store_party_name, s1, ":ai_object")]],
  ...
  [anyone,"lord_tell_objective", [(party_slot_eq, "$g_talk_troop_party", slot_party_ai_state, spai_patrolling_around_center)],
   "We are scouting for enemies around {s1}.", "lord_pretalk",[(party_get_slot, ":ai_object", "$g_talk_troop_party", slot_party_ai_object),
                                                      (str_store_party_name, s1, ":ai_object")]],

#  [anyone,"lord_tell_objective", [(party_slot_eq, "$g_talk_troop_party", slot_party_ai_state, spai_raiding_around_center)],
#   "We travel out to loot the world of {s1} to punish the foe for his misdeeds.", "lord_pretalk",[(party_get_slot, ":ai_object", "$g_talk_troop_party", slot_party_ai_object),
#                                                               (str_store_party_name, s1, ":ai_object")]],

  [anyone,"lord_tell_objective", [(party_slot_eq, "$g_talk_troop_party", slot_party_ai_state, spai_raiding_around_center)],
   #SW - modified dialog
   "We are laying waste to the planet of {s1}.", "lord_pretalk",[(party_get_slot, ":ai_object", "$g_talk_troop_party", slot_party_ai_object),
                                                               (str_store_party_name, s1, ":ai_object")]],
  ...
  [anyone,"lord_ask_follow", [(party_get_slot, ":dont_follow_until_time", "$g_encountered_party", slot_party_dont_follow_player_until_time),
   ...
   "I enjoy your company, {playername}, but there are other things I must attend to. Perhaps in a few days I can join with you again.", "close_window",
   [(assign, "$g_leave_encounter",1)]],
...
##                             (hero_can_join),
##                             ],
##   "I need capable troops like you. Will you join me?", "knight_offer_join",[
##       ]],
 ...
 The thing is, I've found myself in a bit of debt that I must repay very soon. {reg6} credits altogether,\
 and I am honor-bound to return every credit. Unless you've got {reg6} credits with you that you can spare,\
 I've to keep my mind on getting this weight off my neck.", "knight_offer_join_2",[]],
  ...
  [anyone ,"knight_offer_join", [], "Indeed, my friend, I'll be happy to join you.", "knight_offer_join_2",[]],

  [anyone|plyr,"knight_offer_join_2", [(gt, reg6,0),(store_troop_gold, ":gold", "trp_player"),(gt,":gold",reg6)],
   "Here, take it, all {reg6} credits you need. It's only money.", "knight_offer_join_accept",[(troop_remove_gold, "trp_player",reg6)]],
  [anyone|plyr,"knight_offer_join_2", [(le, reg6,0)], "Then let us travel together, my friend.", "knight_offer_join_accept",[]],
  ...
  [anyone ,"knight_offer_join_accept", [(troop_slot_ge, "$g_talk_troop", slot_troop_leaded_party, 1)],
   "I've some trusted troops in my band who could be of use to you. What do you wish to do with them?", "knight_offer_join_accept_party",[
      ]],
  [anyone ,"knight_offer_join_accept", [], "Ah, of course, it might be fun!", "close_window",[
      (call_script, "script_recruit_troop_as_companion", "$g_talk_troop"),
      (assign, "$g_leave_encounter",1)
      ]],
  
  [anyone|plyr,"knight_offer_join_accept_party", [], "You may disband your troops. I've no need for other troops.", "knight_join_party_disband",[]],
  [anyone|plyr,"knight_offer_join_accept_party", [(troop_get_slot, ":companions_party","$g_talk_troop", slot_troop_leaded_party),
      ...
      ], "Your troops may join as well. We need every soldier we can muster.", "knight_join_party_join",[]],
  [anyone|plyr,"knight_offer_join_accept_party", [(is_between,"$g_encountered_party",centers_begin, centers_end)], "Lead your troops off the planet. I shall catch up with you in orbit.", "knight_join_party_lead_out",[]],
  ...
  [anyone ,"knight_join_party_disband", [], "Ah . . . Very well, {playername}. Much as I dislike losing good troops,\
 ...
 My lads and I will travel with you.", "close_window",[
      (call_script, "script_recruit_troop_as_companion", "$g_talk_troop"),
 ...
 I shall maintain a patrol of this area. Return if you have further orders for me.", "close_window",[
  ...
  [anyone,"lord_enter_service_reject", [], "What poodoo!\
 And to think I would offer you a place among my ranks. Begone, beggar, before I have you thrown out!", "close_window",
   [
     (try_begin),
       (store_partner_quest, ":lords_quest"),
  ...
  [anyone,"lord_ask_enter_service", [(gt, "$players_faction", 0),
                                     ...
                                     ], "You are already allied to serve {s5}, are you not?", "lord_give_oath_under_oath_already",[]],
  [anyone|plyr ,"lord_give_oath_under_oath_already", [], "Indeed I am, {s65}. Forgive my rambling.", "lord_pretalk",[]],

  [anyone,"lord_ask_enter_service", [(lt, "$g_talk_troop_relation", -5)], "I accept allegiances only from those I can trust to keep them, {playername}.", "lord_pretalk",[]],
  ...
  [anyone,"lord_ask_enter_service",
   ...
   "You are known as a brave {warrior/warrior} and a fine leader of troops, {playername}.\
 I shall be pleased to accept you into my service and be my commander,\
 if you are ready to swear your allegiance to me.", "lord_give_oath_1",[]],
 ...
 Then we may speak more of this.", "lord_pretalk",[]],
  ...
  [anyone,"lord_give_oath_2", [],  "Good. Then repeat these words with me: I swear allegiance to you as ruler of the {s41}.", "lord_give_oath_3", [
  ...
  [anyone|plyr,"lord_give_oath_3", [],  "I pledge allegiance to you as ruler of the {s41}.", "lord_give_oath_4", []],
  [anyone|plyr,"lord_give_oath_3", [],  "Excuse me, {reg65?my lady:sir}. But I feel I need to think about this.", "lord_give_oath_give_up", []],

  [anyone,"lord_give_oath_4", [],  "I will remain as your loyal and devoted {ally/ally} as long as my breath remains....", "lord_give_oath_5", []],

  [anyone|plyr,"lord_give_oath_5", [],  "I will remain as your loyal and devoted {ally/ally} as long as my breath remains...", "lord_give_oath_6", []],
  [anyone|plyr,"lord_give_oath_5", [],  "{reg65?My lady:Sir}, may I ask for some time to think about this?", "lord_give_oath_give_up", []],

  [anyone,"lord_give_oath_6", [],  "...and I will be at your side to fight your enemies should you need me.", "lord_give_oath_7", []],

  [anyone|plyr,"lord_give_oath_7", [],  "...and I will be at your side to fight your enemies should you need me.", "lord_give_oath_8", []],
  [anyone|plyr,"lord_give_oath_7", [],  "{reg65?My lady:My lord}, please give me more time to think about this.", "lord_give_oath_give_up", []],

  [anyone,"lord_give_oath_8", [],  "Finally, I will uphold your leadership claim and those of our allies.", "lord_give_oath_9", []],

  [anyone|plyr,"lord_give_oath_9", [],  "Finally, I will uphold your leadership claim and those of our allies.", "lord_give_oath_10", []],
  [anyone|plyr,"lord_give_oath_9", [],  "{reg65?My lady:Sir}, I must have more time to consider this.", "lord_give_oath_give_up", []],

  [anyone,"lord_give_oath_10", [],  "Very well. You have given me your allegiance, {playername}. May you uphold it always, with proper courage and devotion to our cause.", "lord_give_oath_go_on_2", []],
  ...
  [anyone,"lord_give_oath_go_on_2",
   ...
   "Let it be known that from this day forward, you are my sworn {ally/ally} and commander.\
 I give you my protection and grant you the right to bear arms in my name, and I pledge that I shall not deprive you of your life, liberty or properties except by the lawful judgment of your peers or by the law and custom of the Galaxy.{reg1? Furthermore I give you the planet of {s1} with all its nearby facilities.:}", "lord_give_oath_go_on_3", []],
  ...
  [anyone,"lord_give_oath_go_on_3",
   ...
   "You have chosen wisely, {playername}. Serve me well and I promise you will rise high.", "lord_give_conclude", []],
...
#                                     (store_character_level, ":player_level", "trp_player"),
#                                     (lt, ":player_level", 10),
#                                     ], "I know not much about you. Keep serving me {playername}. Prove your loyality, then I will know I can trust you and accept your allegiance.", "lord_pretalk",[]],

##  [anyone,"lord_ask_enter_service", [], "What kind of allegiance are you willing to make?", "lord_oath_what_kind",[]],
##
##  [anyone|plyr ,"lord_oath_what_kind", [], "I will give you my allegiance to serve you for two months.", "lord_oath_what_kind_2",[(assign, "$temp", 60)]],
##  [anyone|plyr ,"lord_oath_what_kind", [], "I will give you my allegiance to serve you for three months.", "lord_oath_what_kind_2",[(assign, "$temp", 90)]],
##  [anyone|plyr ,"lord_oath_what_kind", [], "I will give you my allegiance to serve you for six months.", "lord_oath_what_kind_2",[(assign, "$temp", 180)]],
##  [anyone|plyr ,"lord_oath_what_kind", [], "I will give you my allegiance to serve you indefinitely.", "lord_oath_what_kind_2",[(assign, "$temp", 720)]],
...
##  
##  [anyone|plyr, "lord_oath_what_do_you_want", [], "I ask for nothing but your blessing, sir.", "lord_oath_consider",[(assign,"$temp2",0)]],
##  [anyone|plyr, "lord_oath_what_do_you_want", [], "I only ask for the right to have my own banner, sir.", "lord_oath_consider",[(assign,"$temp2",1)]],
##  [anyone|plyr, "lord_oath_what_do_you_want", [], "I just ask for the right to hold one stronghold, sir.", "lord_oath_consider",[(assign,"$temp2",2)]],
##  [anyone|plyr, "lord_oath_what_do_you_want", [], "I ask for the right to hold two strongholds, sir.", "lord_oath_consider",[(assign,"$temp2",4)]],
##  [anyone|plyr, "lord_oath_what_do_you_want", [], "I ask for the right to hold three strongholds, sir.", "lord_oath_consider",[(assign,"$temp2",6)]],
##  [anyone|plyr ,"lord_oath_what_do_you_want", [], "Maybe I should give more thought to this, sir.", "lord_oath_what_kind_cancel",[]],
##  
...
##      (lt, ":cost", ":benefit"),
##      ], "That is agreeable {playername}. Give me your allegiance now and I will accept you as my follower and offer you my protection.", "lord_give_oath_go_on",[]],
##
##  [anyone ,"lord_oath_consider", [], "Hmmm. What you ask for is not acceptible {playername}.", "close_window",[]],
##
##  [anyone|plyr,"lord_give_oath_go_on", [(eq, "$temp", 60)],  "I give you my allegiance lord, that I will remain in your service for two months.\
## During this time, I will be faithful to you,\
## I will not act in a way to cause you harm, and I will be at your side to fight your enemies should you need me.", "lord_give_oath_go_on_2", []],
##  [anyone|plyr,"lord_give_oath_go_on", [(eq, "$temp", 90)],  "I give you my allegiance lord, that I will remain in your service for three months.\
## During this time, I will be faithful to you,\
## I will not act in a way to cause you harm, and I will be at your side to fight your enemies should you need me.", "lord_give_oath_go_on_2", []],
##  [anyone|plyr,"lord_give_oath_go_on", [(eq, "$temp", 180)],  "I give you my allegiance lord, that I will remain in your service for six months.\
## During this time, I will be faithful to you,\
## I will not act in a way to cause you harm, and I will be at your side to fight your enemies should you need me.", "lord_give_oath_go_on_2", []],
##  [anyone|plyr,"lord_give_oath_go_on", [(gt, "$temp", 700)],  "I give you my allegiance lord, that I will remain as your loyal and devoted {man/follower} as long as my breath remains.\
## I will never act in a way to cause you harm, and I will be at your side to fight your enemies should you need me.", "lord_give_oath_go_on_2", []],
##  
...
#      (faction_set_slot, "$g_talk_troop_faction", slot_faction_marshall, "trp_player"),
 ...
 I know you will prove yourself worthy of the trust I have placed in you.", "close_window", [(assign, "$g_leave_encounter",1)]],
 ...
 and our enemies shall fall swiftly.\
 However, to enter my service you must first renounce all allegiances,\
 ...
 "Then it is my pleasure to welcome you to the service of my faction. From this day on, {playername},\
 ...
 Moreover, I will have special tasks for you from time to time, as may some of my other rulers.\
 Serve, fight, and honor your allegiances. These things will take you far, if you've a mind for promotion.\
 May the Force grant us long lives and many victories to toast!", "close_window",[(assign, "$g_leave_encounter",1)]],

  [anyone,"lord_ask_leave_service", [(ge, "$g_talk_troop_relation", 1)], "Hrm.\
 Has your allegiance become burdensome, {playername}? It is unusual for anyone to request to leave our cause,\
 ...
 Though you would be sorely missed.", "lord_ask_leave_service_verify",[]],
  [anyone,"lord_ask_leave_service", [], "Leave our cause? Hmm, perhaps it would be for the best...\
 ...
 I hope you'll banish such unworthy thoughts from your mind from now on.", "lord_pretalk",[]],
  ...
  [anyone,"lord_ask_leave_service_3", [], "As you wish. I hereby declare your allegiance to be null and void.\
 ...
 You are free, {playername}.", "lord_ask_leave_service_end",
  ...
  [anyone|plyr ,"lord_ask_leave_service_end", [], "Thank you, sir. It was an honor to serve you..", "lord_ask_leave_service_end_2",[]],
  ...
  [anyone ,"lord_ask_leave_service_end_2", [], "Good-bye then, {playername}, and good luck go with you.", "close_window",
   [(assign, "$g_leave_encounter", 1)]],
...
##                                    ]+gender_fix(reg3, ":quest_target_troop")+[
  ...
  [anyone|plyr,"lord_active_mission_2",
   ...
   "Oh, indeed. I've captured an officer from {s13} for you.", "capture_enemy_hero_thank",
   []],

  [anyone,"capture_enemy_hero_thank", [],
   "Many thanks, my friend. They will serve very well for a bargain. You've done fine work here. Please accept these {reg5} credits for your help.", "capture_enemy_hero_thank_2",
...
##   "Indeed sir. I have captured a {s3}.", "lord_generic_mission_thank",[(quest_get_slot, ":quest_target_troop", "qst_capture_messenger", slot_quest_target_troop),
##                                                                     (party_remove_prisoners, "p_main_party", ":quest_target_troop", 1),
##                                                                     (party_add_prisoners, "$g_encountered_party", ":quest_target_troop", 1),#Adding him to the dungeon
...
##
  ...
  [anyone,"lord_raise_troops_thank", [],
   "These troops may well turn the tide in my plans, {playername}. I am confident you've trained them well. My thanks and my compliments to you.", "lord_raise_troops_thank_2",[]],
  ...
  [anyone|plyr,"lord_active_mission_2", [#(troop_slot_eq, "$g_talk_troop", slot_troop_is_prisoner, 0),
   ...
   "Here are all the taxes from {s3}. It comes up to {reg19} credits.", "lord_collect_taxes_success",
   []],
  ...
  [anyone|plyr,"lord_active_mission_2", [#(troop_slot_eq, "$g_talk_troop", slot_troop_is_prisoner, 0),
   ...
   "Here are the taxes from {s3}. It comes up to {reg19} credits.", "lord_collect_taxes_half_success",
   []],
 ...
 I could only collect {reg19} credits.", "lord_collect_taxes_fail",
   []],
 ...
 I promised you a fifth of the taxes, so that amounts to {reg21} credits.\
 If you give me {reg20} credits, you may keep the difference.\
 ...
 You can forget the money I promised you, I'm taking {reg20} credits from what you collected,\
 and you're lucky I'm leaving you a few credits for honor's sake.", "lord_pretalk",
   [(troop_remove_gold, "trp_player", reg20),
    (quest_set_slot, "qst_collect_taxes", slot_quest_gold_reward, 0),
    (call_script, "script_end_quest", "qst_collect_taxes"),
    ]],
  ...
  [anyone,"lord_collect_taxes_fail", [],
   "What a bloody mess you've gotten us into, {playername}.\
...
Hand over my {reg19} credits, if you please, and end our business together.", "lord_pretalk",
   [(call_script, "script_change_player_relation_with_troop", "$g_talk_troop", -1),
  ...
  [anyone|plyr,"lord_active_mission_2", [(store_partner_quest,":lords_quest"),
                                         ...
                                         (call_script, "script_get_name_from_dna_to_s50", ":quest_target_dna"),
                                         (str_store_string, s4, s50),],
   "I found {s4} hiding at {s3} and gave them their punishment.", "lord_hunt_down_fugitive_success",
   []],
  ...
  [anyone,"lord_hunt_down_fugitive_success", [],
   "And we'll all be a lot better off without them! Thank you, {playername},\
 for removing this long-festering thorn from my side. It's good to know you can be trusted to handle things\
 with an appropriate level of tactfulness.\
 A bounty I promised, and a bounty you shall have. 300 credits!", "lord_hunt_down_fugitive_success_2",
   [
     (add_xp_as_reward, 300),
    ]],
...
#Post 0907 changes begin
 ...
 An honorable sentiment, to be true. Regardless, you've my thanks for ridding me of that {s44}.", "lord_pretalk",[
...
##  [anyone|plyr,"lord_claim_center_ask", [],
##   "I will leave it to you. I have no interest in holding {s4}.", "lord_claim_center_leave_to_lord",[]],
...
## Sadly you are not born of noble stock, and there are those who will be upset if I allow you to hold a system.\
## So, it saddens me but I must decline your request.", "lord_claim_center_deny", []],
##  
##  [anyone|plyr,"lord_claim_center_deny", [],
##   "This is not fair. I shed my blood to take {s4}. Now another {man/master} will rule over it.", "lord_claim_center_deny_2", []],
##  [anyone|plyr,"lord_claim_center_deny", [],
##   "I understand sir. Do as you will.", "lord_claim_center_leave_to_lord", []],
##  [anyone,"lord_claim_center_deny_2", [],
##   "Remember that you gave me your allegiance {playername}. And you agreed to do as told.", "lord_claim_center_deny_3", []],
...
##                                  ],
##   "I had promised you to defend your right to hold {reg7?a:another} system {playername}. Now I honor that promise.\
## I can think of {no man finer than you/no one better than you} to be the {ruler/ruler} of {s4}.\
## Renew your allegiance to me now. Then I will be your liege,\
## and I'll support you and protect you against all those who oppose your claim.",
##  "lord_claim_center_give_oath",[]],
##
##                                    
##  [anyone|plyr,"lord_claim_center_give_oath", [],  "I give you my allegiance, I will forever be faithful to you,\
...
##  [anyone,"lord_claim_center_direct_3", [],  "You have given your allegiance of fealty {playername}. I accept your allegiance and give you the fief of {s4}.\
...
##   "Nothing. It's not important.", "lord_pretalk",[]],
#Suggest action
  ...
  [anyone|plyr,"lord_suggest_action", [],
   "Cheat:I want to know how much wealth you have.", "lord_suggest_learn_wealth",[]],
  ...
  [anyone|plyr,"lord_suggest_action", [(neq, "$talk_context", tc_siege_commander)],
   "Let us attack an enemy planet.", "lord_suggest_attack_enemy_castle",[]],
  [anyone|plyr,"lord_suggest_action", [(neq, "$talk_context", tc_siege_commander)],
   "Let us return back to a friendly planet.", "lord_suggest_go_to_friendly_town",[]],
  [anyone|plyr,"lord_suggest_action", [(neq, "$talk_context", tc_siege_commander)],
  ...
  [anyone|plyr,"lord_suggest_action", [(neq, "$talk_context", tc_siege_commander)],
   "Raid a planet.", "lord_suggest_raid_village",[]],
  [anyone|plyr,"lord_suggest_action", [],
  ...
  [anyone,"lord_suggest_go_to_friendly_town", [],
   "Hmm. Which planet do you suggest we go to?", "lord_suggest_go_to_friendly_town2",[]],
...
##   "Hmm. No, I don't think that's a good idea.", "lord_pretalk",[]],
  ...
  [anyone,"lord_suggest_follow_me", [],
   "Okay, I'll follow you.", "lord_pretalk",[(party_set_slot, "$g_talk_troop_party", slot_party_commander_party, "p_main_party"),
                                (call_script, "script_party_decide_next_ai_state_under_command", "$g_talk_troop_party")]],
...
#Request Mission
 ...
 I've no doubt that you would be up to the task.", "lord_mercenary_service", []],
  ...
  [anyone|plyr,"lord_mercenary_service", [], "Okay, I'll join {s9}.", "lord_mercenary_service_accept", []],
 ...
 and swear that you and your company will remain in service to {s9}\
 ...
 An initial sum of {reg12} credits will be paid to you to seal the contract.\
 ...
 War can be very profitable at times...", "lord_mercenary_elaborate_1",
  ...
  [anyone,"lord_mercenary_service_elaborate_duty", [], 
   "Duties... there are only a few, none of them difficult. The very first thing is to declare your allegiance to our cause.\
 Once that's done, you shall be required to fulfill certain responsibilities.\
 You'll participate in military campaigns, fulfill any duties given to you by your commanders,\
 and most of all you shall attack the enemies of our faction wherever you might find them.", "lord_mercenary_elaborate_1",
   [(faction_get_slot, ":faction_leader", "$g_talk_troop_faction", slot_faction_leader),
    (str_store_troop_name, s10, ":faction_leader")]],
  
  [anyone|plyr,"lord_mercenary_elaborate_1", [], "And what about my duties as a mercenary?", "lord_mercenary_service_elaborate_duty", []],
  [anyone|plyr,"lord_mercenary_elaborate_1", [], "Can I hold on to any planets I conquer?", "lord_mercenary_elaborate_castle", []],
...
#custom_banner end
  ...
  [anyone|plyr,"lord_mercenary_elaborate_1", [], "How much will my services fetch me?", "lord_mercenary_elaborate_pay", []],
  [anyone|plyr,"lord_mercenary_elaborate_1", [], "That sounds satisfactory. I'll fight for you as long as the credits keep flowing.", "lord_mercenary_service_accept", []],
 ...
 Then you would be rewarded with a planet.", "lord_mercenary_elaborate_1", []],
  ...
  [anyone,"lord_mercenary_elaborate_banner", [(faction_slot_eq, "$g_talk_troop_faction", slot_faction_leader, "$g_talk_troop")],
   "Only my commanders have the honor of carrying their own banners.\
 ...
 gaining the right to choose a banner of your own and fight under it in battle.", "lord_mercenary_elaborate_1", []],
  [anyone,"lord_mercenary_elaborate_banner", [], "Only commanders of {s10} have the honor of carrying their own banners.\
 However, after some time of mercenary service, you may, perhaps, earn the opportunity to swear allegiance to {s10} and become his commander,\
 gaining the right to choose a banner of your own and fight under it in battle.", "lord_mercenary_elaborate_1", []],
  ...
  [anyone,"lord_tell_mission", [(eq,"$random_quest_no","qst_deliver_message")],
   "I need to send a datacard to {s13} who should be currently at {s4}.\
 If you will be heading towards there, would you deliver it to them?\
 The datacard needs to be in his hands in 30 days.", "lord_mission_deliver_message",
   [
     (quest_get_slot, ":quest_target_troop", "$random_quest_no", slot_quest_target_troop),
     (quest_get_slot, ":quest_target_center", "$random_quest_no", slot_quest_target_center),
     (str_store_troop_name_link,s9,"$g_talk_troop"),
...
##     (try_end),
  ...
  [anyone|plyr,"lord_mission_deliver_message", [], "Of course, I intend to pass by {s4} and it would be no trouble.", "lord_mission_deliver_message_accepted",[]],
  ...
  [anyone,"lord_mission_deliver_message_accepted", [], "I appreciate it, {playername}. Here's the datacard,\
 and a small sum to cover your travel expenses. Give my regards to {s13} when you see them.", "close_window",
   [(call_script, "script_start_quest", "$random_quest_no", "$g_talk_troop"),
    (call_script, "script_troop_add_gold", "trp_player",30),
    (call_script, "script_change_player_relation_with_troop","$g_talk_troop",1),
    (assign, "$g_leave_encounter",1),
 ...
 for a small favor? A poor show, {playername}. I didn't know you would take offense.", "lord_mission_deliver_message_rejected_rudely_2",[]],
  ...
  [anyone,"lord_tell_mission", [(eq,"$random_quest_no","qst_deliver_message_to_enemy_lord")],
   "I need to deliver a datacard to {s13} of {s15}, who must be at {s4} currently.\
 If you are going towards there, would you deliver my datacard to them? The datacard needs to reach them in 40 days.", "lord_mission_deliver_message",
   [
     (quest_get_slot, ":quest_target_troop", "$random_quest_no", slot_quest_target_troop),
     (quest_get_slot, ":quest_target_center", "$random_quest_no", slot_quest_target_center),
     (str_store_troop_name_link,s9,"$g_talk_troop"),
...
## I really need your help. Please, will you take this datacard to her? She should be at {s4} at the moment.", "lord_mission_told",
##   [
##     (quest_get_slot, ":quest_target_troop", "$random_quest_no", slot_quest_target_troop),
##     (quest_get_slot, ":quest_target_center", "$random_quest_no", slot_quest_target_center),
...
##
 ...
 The visit has been postponed several times already with all the trouble in this sector,\
...
## I want you to go now and bring back {reg1} {s3}. I would ask you to hang the bastards but we are short of troops and we need them back in the ranks.", "lord_mission_told",
##   [
...
## "{s4} has besieged {s5} and, if luck is on our side, that town will not hold for long.\
## Still I promised him to send {reg1} {s3} as reinforcements and I need someone to lead those troops.\
...
## They'll pay 100 credits in return for giving them back {reg1} {s3}.\
## I can always use the money so I accepted their offer.\
...
# Deal with bandits
  [anyone,"lord_tell_mission", [(eq,"$random_quest_no","qst_deal_with_bandits_at_lords_village")],
   "A group of bandits have taken refuge in the planet of {s1}.\
 They are plundering nearby farms and getting rich and fat stealing my taxes and feasting on my nerfs.\
I'd like nothing better than to go out there and teach them a lesson,\
 but I have my hands full at the moment, so I can't do anything about it.", "lord_mission_deal_with_bandits_told",
   [
     ...
     (setup_quest_text,"$random_quest_no"),
	 #SW - modified dialog
     (str_store_string, s2, "@{s13} asked you to deal with the bandits who are occupying the planet of {s15} and then report back to them."),
   ]],
 ...
 If you would clear them out for me, then I would be grateful. Here is some money for the expenses of your campaign.\
...
# Raise troops
  [anyone,"lord_tell_mission", [(eq,"$random_quest_no","qst_raise_troops")],
   "No commander should have to admit this, {playername}, but I was inspecting my soldiers the other day\
 and there are troops here who don't know which end of a blaster is which.\
 {s44}\
 You are a warrior of galatic renown, {playername}. Will you train some troops for me?\
 I would appreciate it.", "lord_tell_mission_raise_troops",[
  ...
  [anyone|plyr,"lord_tell_mission_raise_troops", [], "How many troops do you need?", "lord_tell_mission_raise_troops_2",[]],
  ...
  [anyone,"lord_tell_mission_raise_troops_2", [], "If you can raise {reg1} {s14} and bring them to me, that will probably be enough.", "lord_mission_raise_troops_told",
   [
     ...
     (setup_quest_text,"$random_quest_no"),
     (str_store_string, s2, "@{s9} asked you to raise {reg1} {s14} and bring them back."),
   ]],
 ...
 I shall tell my officers to send you the recruits and attach them to your command.\
 Also, I'll advance you some money to help with expenses. Here, this credit chip should do it.\
...
#Collect Taxes
 ...
 However, it has been far too long since {s3} has delivered the taxes and rents owed to me as its rightful ruler.\
 ...
 If you go there and raise the taxes they owe me, I will grant you one-fifth of everything you collect.", "lord_mission_collect_taxes_told",
   [
     ...
     (str_store_party_name_link,s3,":quest_target_center"),
     (setup_quest_text,"$random_quest_no"),
     (str_store_string, s2, "@{s9} asked you to collect taxes from {s3}. They offered to leave you one-fifth of all the money you collect there."),
   ]],
 ...
 Remember, those {reg9?townsmen:peasants} are sly beasts; they will make every excuse not to pay me my rightful incomes.\
...
#Hunt down fugitive
  [anyone,"lord_tell_mission", [(eq,"$random_quest_no","qst_hunt_down_fugitive")],
   "I have something you could help with; an issue with the lawless villain known as {s4}. \
 He murdered one of my troops and has been on the run from his judgment ever since.\
 I can't let him get away with avoiding justice, so I've put a bounty of 300 credits on his head.\
 Friends of the murdered man reckon that this assassin may have taken refuge with his family at {s3}.\
 You might be able to hunt him down and give him what he deserves, and claim the bounty for yourself.", "lord_mission_hunt_down_fugitive_told",
  ...
  [anyone|plyr,"lord_mission_hunt_down_fugitive_told", [],
   "Then I will hunt him down and give him what he deserves.", "lord_mission_hunt_down_fugitive_accepted",[]],
...
##
 ...
 with a datacard of complaint to the trade guilds and bankers. Why, he'd ruin my good reputation!\
 So I need a {man/woman} I can trust, someone who will guarantee the man's silence. For good.", "lord_mission_told_kill_local_merchant",
  ...
  [anyone|plyr,"lord_mission_told_kill_local_merchant", [], "If you're credits are good, I'll do the job.", "lord_mission_accepted_kill_local_merchant",[]],
  [anyone|plyr,"lord_mission_told_kill_local_merchant", [], "I'm no common murderer. Find someone else for your dirty job.", "lord_mission_rejected",[]],
 ...
 Dispose of him for me and I shall reward you generously.", "close_window",
  ...
  [anyone,"lord_tell_mission", [(eq,"$random_quest_no","qst_meet_spy_in_enemy_town"),
   ...
   "I have a sensitive matter which needs tending to, {playername}, and no trustworthy allies to take care of it. The fact is that I have a spy in {s13} to keep an eye on things for me, and report anything that might warrant my attention. Every week I send someone to collect the spy's reports and bring them back to me. The job's yours if you wish it.", "lord_mission_told_meet_spy_in_enemy_town",
   [
   ]],

  [anyone|plyr,"lord_mission_told_meet_spy_in_enemy_town", [], "I don't mind a bit of espionage. Count me in.", "quest_meet_spy_in_enemy_town_accepted",[]],
  [anyone|plyr,"lord_mission_told_meet_spy_in_enemy_town", [], "I must decline. This cloak-and-blaster work isn't fit for me.", "quest_meet_spy_in_enemy_town_rejected",[]],
  ...
  [anyone|plyr,"quest_meet_spy_in_enemy_town_accepted_response", [], "Will I be paid?", "quest_meet_spy_in_enemy_town_accepted_4",
   []],
  [anyone,"quest_meet_spy_in_enemy_town_accepted_4", [], "Of course, I have plenty of credits in the bank for loyal {troops/women} like you. Do well by me, {playername}, and you'll rise high.", "quest_meet_spy_in_enemy_town_accepted_response",
   []],
  [anyone|plyr,"quest_meet_spy_in_enemy_town_accepted_response", [], "I know what to do. Good-bye.", "quest_meet_spy_in_enemy_town_accepted_end",
   []],
  ...
  [anyone,"lord_tell_mission", [(eq,"$random_quest_no","qst_raid_caravan_to_start_war"),
   ...
   "This peace with {s13} ill suits me, {playername}. We've let them have their way for far too long.\
 Now they get stronger with each passing day and their arrogance knows no bounds.\
 ...
 Witless cowards with no stomach for blood.", "lord_mission_told_raid_caravan_to_start_war",
  ...
  [anyone,"lord_mission_tell_raid_caravan_to_start_war_2", [(quest_get_slot, ":quest_target_faction", "$random_quest_no", slot_quest_target_faction),
                                                            (str_store_faction_name_link, s13, ":quest_target_faction")],
   "Ah, how refreshingly good to hear someone who understands!\
 As a matter of fact, there is something we can do, {playername}. A little bit of provocation.\
 The dogs in {s13} are very fond of their merchant fleets, and rely on them greatly.\
 Now, if one of our ships managed to enter their territory and destroy some of their merchant fleets,\
 they would have ample cause to declare war on our faction.\
 ...
 So what do you say? Are you interested?", "lord_mission_tell_raid_caravan_to_start_war_3",[]],
  ...
  [anyone|plyr,"lord_mission_tell_raid_caravan_to_start_war_3", [], "Why don't you raid the fleets yourself?", "lord_mission_tell_raid_caravan_to_start_war_4",[]],

  [anyone,"lord_mission_tell_raid_caravan_to_start_war_4", [
  	], "Well, {playername}, some of the lords in our faction\
 ...
 All in all, a few lords might be upset at your endeavour, but I am sure you won't be bothered with that.", "lord_mission_tell_raid_caravan_to_start_war_5",[]],
  ...
  [anyone|plyr,"lord_mission_tell_raid_caravan_to_start_war_5", [], "Then I will go and raid those fleets!", "quest_raid_caravan_to_start_war_accepted",[]],
 ...
 Now, don't forget that you must capture and loot at least {reg13} fleets to make sure that those fools in {s13} get really infuriated.\
 Once you do that, return to me and make sure you are not captured by their patrols.\
 If they catch you, our plan will fail without a doubt and you will be facing a long time in prison.\
 Now, good luck and good hunting to you.", "close_window",
   [
     ...
     (setup_quest_text,"$random_quest_no"),
     (str_store_string, s2, "@{s9} asked you to capture and loot {reg13} merchant fleets so as to provoke a war with {s13}."),
     (call_script, "script_start_quest", "$random_quest_no", "$g_talk_troop"),
     (call_script, "script_change_player_relation_with_troop","$g_talk_troop",5),
     (assign, "$g_leave_encounter",1),
    ]],
 ...
 "Well, some of the servants working my fields in {s4} have run away. The ungrateful nerf herders,\
 I let them tend to my herd, harvest my crops and rent my buildings, and this is how they repay me!\
 From what I've been hearing, they're flying to {s3} as fast as they can,\
 ...
 I should really have their contract terminated, but we need hands for the upcoming harvest,\
 so I'll let them go off this time.", "lord_mission_told",
   [
       (quest_get_slot, ":quest_target_center", "$random_quest_no", slot_quest_target_center),
       (quest_get_slot, ":quest_object_center", "$random_quest_no", slot_quest_object_center),
       ...
       (setup_quest_text,"$random_quest_no"),
       (str_store_string, s2, "@{s9} asked you to catch the three groups of runaway servants and bring them back to {s4}, alive and breathing. They said that all three groups are heading towards {s3}."),
    ]],

  [anyone,"lord_tell_mission", [(eq,"$random_quest_no","qst_follow_spy")],
 "I have good information that a man on this very planet is actually an enemy spy.\
 He should be seized and shot for his impudence,\
 but we also believe that very soon he will leave the planet to meet with his master,\
 the man to whom the spy feeds all his little whispers.\
 The spy himself is of little importance, but the master is a dangerous man, and could tell us a great deal\
 if we could only get our hands on him...", "lord_tell_mission_follow_spy",[]],
  [anyone,"lord_tell_mission_follow_spy", [],
 "I want you to wait here until the spy leaves the planet. Then you must follow him, stealthily, to the meeting place.\
 ...
 "No, this skulking is not for me.", "lord_tell_mission_follow_spy_rejected", []],
  ...
  [anyone,"lord_tell_mission_follow_spy_accepted", [],
   "Good, I'm sure you'll do a fine job of it. One of my troops will point the spy out to you when he leaves,\
 ...
 I need someone to capture one of the commanders of {s13} and bring them to me.\
 Afterwards, I'll be able to exchange them in return for an associate of mine held by {s13}.\
 It is a simple enough job, but whomever you choose will be guarded by an elite band of personal bodyguards.\
 ...
 and I'll toast your name in my hall when you return! And reward you for your efforts, of course...", "close_window",
   [
     ...
     (str_store_faction_name_link, s13, ":quest_target_faction"),
     (setup_quest_text, "$random_quest_no"),
     (str_store_string, s2, "@{s11} asked you to capture a commander from {s13}, any commander, and then drag your victim back to {s11} for safekeeping."),
     (call_script, "script_start_quest", "$random_quest_no", "$g_talk_troop"),
     #TODO: Change this value
     (call_script, "script_change_player_relation_with_troop", "$g_talk_troop", 1),
     (assign, "$g_leave_encounter",1),
 ...
 I shall have to make do without.", "lord_pretalk",
  ...
  [anyone,"lord_tell_mission", [(eq,"$random_quest_no","qst_collect_debt")],
   "Some time ago, I loaned out a considerable sum of money to {s3}. {reg4} credits, to be precise.\
 They were supposed to pay it back within a month but I haven't received a credit from them since.\
 That was months ago. If you could collect the debt from them on my behalf,\
 ...
 What do you say?", "lord_tell_mission_collect_debt",
   [
     ...
     (str_store_party_name_link,s4,":quest_target_center"),
     (setup_quest_text,"$random_quest_no"),
     (str_store_string, s2, "@{s9} asked you to collect the debt of {reg4} credits {s3} owed to them. {s3} was at {s4} when you were given this quest."),
   ]],
 ...
 "If you leave now, you should be able to find them at {s4}.\
 I've no doubt that they will be suitably embarrassed by their conduct and give you all the money that is owed.", "lord_tell_mission_collect_debt_3", []],
  ...
  [anyone,"lord_tell_mission_collect_debt_accepted", [], "You made me very happy by accepting this {playername}. Please, talk to {s3} and don't leave without my money.", "close_window",
   [(call_script, "script_start_quest", "$random_quest_no", "$g_talk_troop"),
    (call_script, "script_change_player_relation_with_troop","$g_talk_troop",2),
    (assign, "$g_leave_encounter",1),
   ]],
...
##
 ...
 The Galaxy would be rid of them in an instant were it their commanders, such as {s15}.\
 ...
 With your help, naturally.", "lord_tell_mission_incriminate_commander",[]],
  ...
  [anyone,"lord_tell_mission_incriminate_commander_rejected", [], "Dishonorable? Bah!\
 ...
 I shall have to find someone whose loyalty I can trust.", "lord_pretalk",
  ...
  [anyone,"lord_tell_mission_incriminate_commander_2", [], "I have written a fake datacard to {s15},\
 bearing my own seal, which implicates them in a conspiracy with us to stage a coup in {s14}, in my favor.\
 If we can make {s13} believe the datacard is genuine, they will deal with {s15} very swiftly.\
 Of course, the challenge there is to convince {s13} that the datacard is indeed real...", "lord_tell_mission_incriminate_commander_3",[]],

  [anyone|plyr,"lord_tell_mission_incriminate_commander_3", [], "Please continue, {s65}...", "lord_tell_mission_incriminate_commander_4",[]],
  [anyone|plyr,"lord_tell_mission_incriminate_commander_3", [], "No, I will not sully myself with this dishonorable scheme.", "lord_tell_mission_incriminate_commander_rejected",[]],

  [anyone,"lord_tell_mission_incriminate_commander_4", [], "This is where you come into play.\
 You'll take the datacard to {s14}, then give it to one of your soldiers and instruct them to take it to {s15}.\
 I will have one of my spies inform the planet garrison so that your man will be arrested on his way.\
 The guards will then find the datacard and take it to {s13}.\
 They'll torture your man, of course, to try and get the truth out of them,\
 but all he knows is that you ordered the datacard to be delivered to {s15} under the utmost secrecy.\
 ...
 Your messenger must be someone trustworthy. If you sent the datacard with a simple farmer, someone expendable,\
 {s13} might suspect a plot. He may have the wits of a snail, but even a snail can see the obvious.\
 Give the datacard to someone of rank. One of your {s9}, perhaps.", "lord_tell_mission_incriminate_commander_8",[]],
 ...
 and what is the purpose of soldiers if not to die at our say-so?", "lord_tell_mission_incriminate_commander_10",[]],
  ...
  [anyone|plyr,"lord_tell_mission_incriminate_commander_10", [], "No, I'll not sacrifice one of my chosen troops.", "lord_tell_mission_incriminate_commander_rejected",[]],
 ...
 Here is the datacard, as well as 300 credits for your expenses.\
 ...
 Thankfully we have a mutual agreement of prisoner exchange, and they will release my troops,\
...
##         (setup_quest_giver,"$random_quest_no", "str_given_by_s1_in_wilderness"),
##       (try_end),
       (str_store_string, s2, "@{s9} has requested you to bring them {reg1} {s3} as prisoners."),
    ]],
...
#### Freelancer - Kham Implementation ####
  ...
  [anyone|auto_proceed,"lord_leave", [(faction_slot_eq,"$g_talk_troop_faction",slot_faction_leader,"$g_talk_troop")],
   "Of course, {playername}. Good-bye.", "close_window",[(eq,"$talk_context",tc_party_encounter),(assign, "$g_leave_encounter", 1)]],
  ...
  [anyone|auto_proceed,"lord_leave", [(ge, "$g_talk_troop_faction_relation", 0)],
   "Yes, yes. Good-bye.", "close_window",[(eq,"$talk_context",tc_party_encounter),(assign, "$g_leave_encounter", 1)]],
...
#Royal family members
 ...
 I hope they never forget their humiliation.\
 ...
 The truth cannot be proven at the end of a blaster, but you willingly put your life at stake for my honor.\
 ...
 I hope we shall meet again sometime in the future.", "lady_escort_lady_succeeded",
  ...
  [anyone,"start", [
   ...
   "Oh, {playername}, you brought them back to me! Thank you ever so much for rescuing my {s17}.\
 Please, take this as some small repayment for your noble deed.", "lady_generic_mission_succeeded",
  ...
  [anyone|plyr,"lady_generic_mission_succeeded", [], "Always an honor to serve, {s65}.", "lady_pretalk",[]],
...
##
  ...
  [anyone,"lady_ask_for_quest", [(eq, "$random_quest_no", "qst_rescue_lord_by_replace")],
   "Oh, I fear I may never see my {s17}, {s13}, again... They are a prisoner in the dungeon of {s14}.\
 We have tried to negotiate their ransom, but it has been set too high.\
 We can never hope to raise that much money without selling everything we own,\
 and we are all aware {s13} would rather spend their life in prison than make us destitute.\
 Instead I came up with a plan to get them out of there, but it requires someone to make a great sacrifice,\
 and so far my pleas have fallen on deaf ears...", "lady_mission_told",
   [
     ...
     (str_store_party_name_link, s14, ":quest_target_center"),
     (setup_quest_text,"$random_quest_no"),
     (str_store_string, s2, "@{s11} asked you to rescue her {s17}, {s13}, from {s14} by switching clothes and taking their place in prison."),
    ]],
 ...
 The only way we can talk to each other is by exchanging datacards whenever we can,\
...
They are going around making terrible accusations against me, impugning my honor at every turn!\
 Because they cannot harm my husband directly, they are using me as a target to try and stain our name.\
 You should hear the awful things they have said! I only wish there was someone brave enough to make them recant their slander,\
 but {s13} is a very fine fighter, and widely feared...", "lady_quest_duel_for_lady_3",[]],

  [anyone|plyr,"lady_quest_duel_for_lady_3", [], "I fear them not, {s65}. I will make them take back those lies.", "lady_quest_duel_for_lady_3_accepted",[]],
  [anyone,"lady_quest_duel_for_lady_3_accepted", [], "Oh! I can't ask that of you, {playername}, but...\
 I would be forever indebted to you, and you are so sure. It would mean so much if you would defend my honor.\
 Thank you a thousand times, all my prayers and my favor go with you.", "close_window",
  ...
  [anyone|plyr,"lady_quest_duel_for_lady_3", [], "If they are that dangerous, perhaps maybe it would be better to ignore them...", "lady_quest_duel_for_lady_3_rejected",[]],
  [anyone,"lady_quest_duel_for_lady_3_rejected", [], "Oh... Perhaps you're right, {playername}.\
 I should let go of these silly childhood ideas of chivalry and courage. {troops/People} are not like that,\
...
#Leave
  [anyone|plyr,"lady_talk", [], "I want to improve my relation with a commander. Can you help me?", "lady_restore_relation",[]],
 ...
 And if you can go up to {reg12} credits, that would really help smooth things out.", "lady_restore_relation_4",[]],

  [anyone|plyr,"lady_restore_relation_4", [(store_troop_gold,":gold", "trp_player"),
                                           (ge, ":gold", "$lady_restore_cost_1"),
                                           (assign, reg10, "$lady_restore_cost_1")],
   "I think a gift of {reg10} credits will do.", "lady_restore_relation_5",[(assign, "$temp", 1), (assign, "$temp_2", "$lady_restore_cost_1")]],
  [anyone|plyr,"lady_restore_relation_4", [(store_troop_gold,":gold", "trp_player"),
                                           (ge, ":gold", "$lady_restore_cost_2"),
                                           (assign, reg11, "$lady_restore_cost_2")],
   "Maybe I can afford {reg11} credits.", "lady_restore_relation_5",[(assign, "$temp", 2), (assign, "$temp_2", "$lady_restore_cost_2")]],
  [anyone|plyr,"lady_restore_relation_4", [(store_troop_gold,":gold", "trp_player"),
                                           (ge, ":gold", "$lady_restore_cost_3"),
                                           (assign, reg12, "$lady_restore_cost_3")],
   "In that case, I am ready to spend {reg12} credits.", "lady_restore_relation_5",[(assign, "$temp", 3), (assign, "$temp_2", "$lady_restore_cost_3")]],
...
#Convincing bargaining
  ...
  [anyone|plyr,"convince_options", [(assign, reg8, "$convince_value")], "Then I'll make it worth your while. ({reg8} credits)", "convince_bribe",[]],
 ...
 {reg8} credits should do it. If you agree, then I'll go with your suggestion.", "convince_bribe_verify",[]],
  ...
  "Very well, please accept these {reg8} credits as a token of my gratitude.", "convince_bribe_goon",[]],
 ...
 and let me assure you you'll get none.", "lord_pretalk",[]],
  ...
  [anyone,"convince_persuade_begin", [], "Be silent, {playername}!\
...
#Seneschal
  ...
  [anyone,"start", [(troop_slot_eq, "$g_talk_troop", slot_troop_occupation, slto_faction_seneschal),
   ...
   "I must congratulate you on your victory. Welcome to {s1}.\
 We, the keepers of this planet, are at your service.", "siege_won_seneschal_1",[]],
  [anyone|plyr,"siege_won_seneschal_1", [], "Are you the seneschal?", "siege_won_seneschal_2",[]],
  [anyone,"siege_won_seneschal_2", [], "Indeed I am, {sir/madam}.\
 I have always served the masters of {s1} to the best of my ability, whichever side they might be on.\
 Thus you may count on my utmost loyalty for as long as you are the {ruler/ruler} of this place.\
 Now, do you intend to keep me on as the seneschal? I promise you will not be disappointed.", "siege_won_seneschal_3",[]],
  ...
  [anyone,"siege_won_seneschal_4", [], "Thank you. If you do not mind my impudence,\
 may I inquire as to what you wish to do with the planet?", "siege_won_seneschal_5",[]],

  [anyone|plyr,"siege_won_seneschal_5", [], "I will sell it to another commander.", "siege_won_seneschal_6",[]],
  ...
  [anyone,"siege_won_seneschal_list_options", [], "According to our galactic laws and traditions,\
 you can do one of several things.\
 First, you could station a garrison here to protect the planet from any immediate counterattacks,\
 then request an audience with some wealthy ruler and ask them to make you an offer.\
 It would be worth a tidy sum, believe you me.\
 If you do not wish to sell, then you will have to find yourself a leader and protector who would accept allegiance from you.\
 Without a leader's investiture and an army at your back, you would have a difficult time holding on to the system.\
 Both you and {s1} would become great big targets for anyone with a few soldiers and a scrap of ambition.\
 ", "siege_won_seneschal_list_options_2",[]],

  [anyone|plyr,"siege_won_seneschal_list_options_2", [], "What do you mean, a leader and protector? I won this place by my own hand, I don't need anyone else!", "siege_won_seneschal_list_options_3",[]],
  [anyone,"siege_won_seneschal_list_options_3", [], "Of course you don't, my apologies.\
 However, no commander in the Galaxy will recognize your claim to the planet unless it is verified by a ruler's decree.\
 They would call {s1} an outlaw base and take it from you at the earliest opportunity.\
 Surely not even you could stand against a whole army.", "siege_won_seneschal_list_options_4",[]],
  ...
  [anyone,"siege_won_seneschal_6", [], "I am very pleased to hear it.\
 I am only trying to serve you to the best of my ability. Now,\
 if at any time you find you have further need of me,\
 I will be in the main hall arranging a smooth handover of the system to your forces.\
 ", "close_window",[]],
 ...
 Let me extend my welcome to you as the seneschal of {s1}.", "seneschal_intro_1",[]],
  ...
  [anyone,"seneschal_intro_1b", [], "Ah, a seneschal's duties are many, good {ruler/ruler}.\
 For example, I collect the rents from my ruler's people, I manage the planet's supplies,\
 I deal with the local farmers and citizens, I take care of the stronghold staff, I arrange supplies for the garrison...\
...
# Ryan END
  ...
  [anyone|plyr,"seneschal_talk", [], "I must take my leave of you now. Good-bye.", "close_window",[]],
...
#caravan merchants
 ...
 Take these credits, as promised. Perhaps we could travel together again, someday?", "close_window",
   [
  ...
  [anyone,"start", [(eq,"$talk_context", tc_party_encounter),
   ...
   "Be warned! This fleet is under the protection of {s9}.\
 Change your intercept course, or we'll alert the nearest {s9} patrol!", "merchant_talk",[]],
  ...
  [anyone|plyr,"merchant_talk", [(le,"$talk_context", tc_party_encounter),
   ...
   "You are trespassing in {s17} territory. I am confiscating this fleet and all its goods!", "caravan_start_war_quest_1",[]],
...
##       ]],
  ...
  [anyone,"merchant_demand_toll", [(gt, "$g_strength_ratio", 70),
                                        ...
                                        (val_add, reg6, 40),
                                        (assign, "$temp", reg6),
                                        ], "Please, I don't want any trouble. I can give you {reg6} credits, just let us go.", "merchant_demand_toll_2",[]],
  [anyone,"merchant_demand_toll", [(store_div, reg6, "$g_ally_strength", 4),
                                        (val_add, reg6, 10),
                                        (assign, "$temp", reg6),
                                        ], "I don't want any trouble. I can give you {reg6} credits if you'll let us go.", "merchant_demand_toll_2",[]],
  
  [anyone|plyr,"merchant_demand_toll_2", [], "Agreed, hand it over and you may go in peace.", "merchant_demand_toll_accept",[]],
  [anyone,"merchant_demand_toll_accept", [(assign, reg6, "$temp")], "Very well then. Here's {reg6} credits. ", "close_window",
   [(assign, "$g_leave_encounter",1),
    (call_script, "script_troop_add_gold", "trp_player","$temp"),
...
### Troop commentaries changes end
  ...
  [anyone,"caravan_offer_protection", [],
   "These trade routes are dangerous indeed. One can never have enough protection.", "caravan_offer_protection_2",
  ...
  [anyone,"caravan_offer_protection_2", [(get_party_ai_object,":caravan_destination","$g_encountered_party"),
   ...
   "We are heading to {s1}. I will pay you {reg2} credits if you escort us there.", "caravan_offer_protection_3",
   []],
...
# Prison Guards
  ...
  [anyone,"prison_guard_visit_prison", [],
   "You need to get permission from the commander to talk to prisoners.", "prison_guard_visit_prison_2",[]],
  ...
  [anyone|plyr,"prison_guard_visit_prison_4", [(store_troop_gold,":gold","trp_player"),(ge,":gold",100)],
   "Say... I found a credit chip with a sum of 100 credits nearby. Of course, I'm sure it belongs to you...", "prison_guard_visit_prison_5",[]],
...
## You can go in. But you must leave your weapons with me. No one's allowed into the court with weapons.", "close_window",[]],
...
## But you must leave your weapons with me. No one's allowed into the court with weapons.", "close_window",[]],
...
##   "They told us to leave the system to the new garrison {sir/madam}. So we left and came to rejoin you.", "player_old_garrison_encounter",[]],
##  
...
##
 ...
 But I think he would approve of you refueling here.\
...
##   "TODO: Sir, {s1} ordered me to bring {reg1} {s2} for ransom.", "guard_prisoners_brought",
##   [(quest_get_slot, ":quest_target_amount", "qst_bring_prisoners_to_enemy", slot_quest_target_amount),
...
##                                    (assign, reg1, ":quest_target_amount"),
##                                    (str_store_troop_name_plural,2,":quest_object_troop")],
##   "TODO: Sir, {s1} ordered me to bring {reg1} {s2} for ransom, but some of them died during my expedition.", "guard_prisoners_brought_some",
##   [(quest_get_slot, ":quest_target_amount", "qst_bring_prisoners_to_enemy", slot_quest_target_amount),
##    (quest_get_slot, ":quest_target_center", "qst_bring_prisoners_to_enemy", slot_quest_target_center),
##    (quest_get_slot, ":quest_object_troop", "qst_bring_prisoners_to_enemy", slot_quest_object_troop),
##    (party_count_prisoners_of_type, ":num_prisoners", "p_main_party", ":quest_object_troop"),
...
## But I think he would approve of you refueling here, {sir/madam}.\
...
#Post 0907 changes begin
  ...
  [anyone,"freed_hero_answer_2", [],
   "Thank you, good {sir/lady}. I never forget someone who's done me a good turn.", "close_window",
   []],
...
# Local merchant
  ...
  [anyone|plyr,"local_merchant_mercy", [(quest_get_slot, ":quest_giver_troop", "qst_kill_local_merchant", slot_quest_giver_troop),(str_store_troop_name, s2, ":quest_giver_troop")],
   "I have nothing against you, sir. But {s2} wants you dead. Sorry.", "local_merchant_mercy_no",[]],
 ...
 And you will sign a paper stating that he owes you nothing.", "local_merchant_mercy_yes_3",[]],
  ...
  [anyone|plyr,"local_merchant_mercy_yes_4", [], "And if they hear so much as a hint of a complaint about this issue, then I'll come back for you,\
...
#SW - Bounty Hunting begin  - http://forums.taleworlds.com/index.php/topic,59300.0.html
  [anyone,"start", [
			   ...
			   ], "Why are you looking at me like that. Do I know you?", "bounty_1",[]],
  [anyone,"start", [
				#(call_script, "script_race"),
  ...
  [anyone,"bounty_2", [], "I might be him. It depends on who you are and why you are asking...", "bounty_3",[]],
  #[anyone|plyr,"bounty_3", [], "{s39} I can assure you I....", "bounty_4",[]],
  [anyone|plyr,"bounty_3", [], "There is a reward out for you and I'm here to collect it.", "bounty_4",[]],
  [anyone,"bounty_4", [(eq, "$g_talk_troop", "$bounty_target_1")], "Don't you know who I am? I'm a CIS officer and you dare threaten me! I'm going to enjoy this...", "close_window",
  ...
  [anyone,"bounty_4", [(eq, "$g_talk_troop", "$bounty_target_2")], "It's my land, not his, and I'm not giving it up without a fight!", "close_window",
   [(set_party_battle_mode),
    (try_for_agents, ":cur_agent"),
      (agent_get_troop_id, ":cur_agent_troop", ":cur_agent"),
  ...
  [anyone,"bounty_4", [(eq, "$g_talk_troop", "$bounty_target_4")], "I may not have my gang anymore, but I can still easily take down somebody like you...", "close_window",
   [(set_party_battle_mode),
    (try_for_agents, ":cur_agent"),
      (agent_get_troop_id, ":cur_agent_troop", ":cur_agent"),
  ...
  [anyone,"bounty_4", [(eq, "$g_talk_troop", "$bounty_target_6")], "Hey, even I get boarded sometimes, I didn't have a choice. You are not taking me without a fight!", "close_window",
   [(set_party_battle_mode),
    (try_for_agents, ":cur_agent"),
      (agent_get_troop_id, ":cur_agent_troop", ":cur_agent"),
...
#SW - Bounty Hunting Begin - http://forums.taleworlds.com/index.php/topic,59300.0.html
# this is just a note that you can put dialog here if you want there to be a separate NPC's for bounty hunting quests (currently using the tavern keepers)
#SW - Bounty Hunting End
...
# Village traitor
 ...
 We'll go now and talk to your neighbors, and if they verify your story, I'll go my way.", "fugitive_4",[]],
  ...
  [anyone|plyr,"sacrificed_messenger_1", [(quest_get_slot, ":quest_target_center", "qst_incriminate_loyal_commander", slot_quest_target_center),
   ...
   "Take this datacard to {s1} and give it to {s2}.", "sacrificed_messenger_2",[]],
  ...
  [anyone|plyr,"sacrificed_messenger_cancel_2", [(quest_get_slot, ":quest_giver", "qst_incriminate_loyal_commander", slot_quest_giver_troop),
      ...
      ], "There's a trap set up for you on the planet.\
 {s3} ordered me to sacrifice one of my best to fool the enemy,\
 ...
 I would and will follow you to the gates of hell. But there's no honor in dying this way.", "close_window",[]],
...
#Runaway Peasants
  ...
  [anyone|plyr,"runaway_serf_intro_1", [(quest_get_slot, ":lord", "qst_bring_back_runaway_serfs", slot_quest_giver_troop),
   ...
   "I have been sent by your {s4} whom you are escaping from. He will not punish you if you return now.", "runaway_serf_intro_2",[]],
  ...
  [anyone,"runaway_serf_intro_2", [(quest_get_slot, ":target_center", "qst_bring_back_runaway_serfs", slot_quest_target_center),
   ...
   "My good {sir/madam}. Our life on the planet of {s1} was unbearable. We worked all day long and still went to bed hungry.\
 We are going to {s6} to start a new life, where we will be treated like sentient beings.", "runaway_serf_intro_3",[]],
  ...
  [anyone|plyr,"runaway_serf_intro_3", [(quest_get_slot, ":quest_object_center", "qst_bring_back_runaway_serfs", slot_quest_object_center),
                                        (str_store_party_name, s1, ":quest_object_center"),],
   "You have gone against our laws by running from your contract. You will go back to {s1} now!", "runaway_serf_go_back",
   [(quest_get_slot, ":quest_object_center", "qst_bring_back_runaway_serfs", slot_quest_object_center),
...
#Deserters
 ...
 I want to see all the credit chips you've accumulated next time I see you.", "close_window",[(assign, "$g_leave_encounter",1)]],
  [anyone|plyr,"deserter_paid_talk", [], "Actually, I'm going to make you pay this time.", "deserter_paid_talk_2b",[]],
 ...
 We fight only for ourselves from now on.\
 Now, give us your credits or taste our blasters.", "deserter_talk",[]],
...
##                                 (gt, ":num_deserters", 1)],
##   "If you surrender to me now, you will rejoin the army of your faction without being punished. Otherwise you'll get a taste of my blaster.", "deserter_join_as_prisoner",[]],
  [anyone|plyr,"deserter_talk", [], "When I'm done with you, you'll regret ever leaving your army.", "close_window",[]],
  [anyone|plyr,"deserter_talk", [], "There's no need for things to get heated. I am ready to pay for a safe journey.", "deserter_barter",[]],
...
##  [anyone,"deserter_join_as_prisoner", [], "TODO: We will never surrender!", "close_window",[(encounter_attack)]],
  ...
  [anyone,"deserter_barter", [], "Good. You are clever. You'll pay us {reg5} credits. Then you can go.", "deserter_barter_2",[(assign,"$deserter_tribute",150),(assign,reg(5),"$deserter_tribute")]],
  [anyone|plyr,"deserter_barter_2", [(store_troop_gold,reg(2)),(ge,reg(2),"$deserter_tribute"),(assign,reg(5),"$deserter_tribute")],
   "All right, here's your {reg5} credits.", "deserter_barter_3a",[(troop_remove_gold, "trp_player","$deserter_tribute")]],
  [anyone|plyr,"deserter_barter_2", [],
   "I don't have that much with me", "deserter_barter_3b",[]],
  [anyone,"deserter_barter_3b", [],
   "Too bad. Then we'll have to sell you into slavery.", "close_window",[]],


  [anyone,"deserter_barter_3a", [], "Was that so hard? All right. Go now.", "close_window",[
    (store_current_hours,":protected_until"),
    (val_add, ":protected_until", 72),
    (party_set_slot,"$g_encountered_party",slot_party_ignore_player_until,":protected_until"),
    (party_ignore_player, "$g_encountered_party", 72),
...
#SW - new cantina_drinkers dialog
   [anyone, "start",
      [
        (is_between, "$g_talk_troop", cantina_drinkers_begin, cantina_drinkers_end),
      ],
   "I'm drunk, leave me alone.", "cantina_drinkers_talk", []
   ],
   [anyone|plyr, "cantina_drinkers_talk", [], "Sorry to bother you, goodbye.", "close_window", []],
...
#SW - new cantina_walkers dialog - code primarily created by Mordachai and MartinF
  [anyone ,"start",
      [
        ...
        (is_between, "$g_talk_troop", cantina_walkers_begin, cantina_walkers_end),
   ...
   [anyone, "start",
      [
        (is_between, "$g_talk_troop", cantina_walkers_begin, cantina_walkers_end),
        (lt, reg60, 25), # 25% tell a joke
      ],
   "I like to tell jokes when I am drunk. Want to hear one?", "cantina_walkers_pre_joke",
   []],

   [anyone, "start",
      [
        (is_between, "$g_talk_troop", cantina_walkers_begin, cantina_walkers_end),
        (lt, reg60, 50), # 25% buy a drink
      ],
   "Hey, can you spare some credits for a drink?", "cantina_walkers_pre_drink",
   []],

   [anyone, "start",
      [
        (is_between, "$g_talk_troop", cantina_walkers_begin, cantina_walkers_end),
        (lt, reg60, 75), # 25% try to start a fight
      ],
   "I don't like you.", "cantina_walkers_pre_brawl",
   []],   
   ...
   [anyone, "start",
      [
        (is_between, "$g_talk_troop", cantina_walkers_begin, cantina_walkers_end),
        # 50% random message
        (store_random_in_range, ":offset", 0, 10), # I'm assuming 10 possible random messages
        (store_add, ":message", ":offset", "str_cantina_rand_msg_1"), # grab one of the 10 consecutive messages out of the strings.py
        (str_store_string, s1, ":message"),
      ],
   "{s1}", "cantina_walkers_generic_response",
   []],

 [anyone|plyr, "cantina_walkers_pre_joke", [], "Sure.", "cantina_walkers_tell_joke", []],
 [anyone|plyr, "cantina_walkers_pre_joke", [], "No thanks, goodbye.", "close_window", []],

 [anyone, "cantina_walkers_tell_joke", [
        (store_random_in_range, ":offset", 0, 10), # I'm assuming 10 possible jokes
        (store_add, ":message", ":offset", "str_cantina_joke_1"), # grab one of the 10 consecutive jokes
        (str_store_string, s1, ":message"),
   ], "{s1}", "cantina_walkers_tell_joke", []
 ],
[anyone|plyr, "cantina_walkers_tell_joke", [], "That was great, tell me another!", "cantina_walkers_tell_joke", []],
[anyone|plyr, "cantina_walkers_tell_joke", [], "That was horrible, goodbye.", "close_window", []],

##################### DRINK

[anyone|plyr, "cantina_walkers_pre_drink", [], "Sure.", "cantina_walkers_buy_drink", []],
[anyone|plyr, "cantina_walkers_pre_drink", [], "No thanks, goodbye.", "close_window", []],

[anyone|plyr, "cantina_walkers_buy_drink", 
		[
			(troop_remove_gold, "trp_player", 5),
            (play_sound, "snd_money_paid"),
			#(display_message, "@You bought a drink.", 0x88ffff),
		], "Here's some credits, enjoy!", "close_window", []],

######################## BRAWL		
		
[anyone|plyr, "cantina_walkers_pre_brawl", [], "I'm sorry.", "cantina_walkers_pre_brawl_2", []],

[anyone, "cantina_walkers_pre_brawl_2", [], "Don't insult me. You should watch yourself. I have the death sentence in twelve systems.", "cantina_walkers_pre_brawl_3", []],

[anyone|plyr, "cantina_walkers_pre_brawl_3", [], "I'll be careful then.", "cantina_walkers_pre_brawl_4", []],
[anyone|plyr, "cantina_walkers_pre_brawl_3", [], "I'm not worth the effort, let me buy you a drink.", "close_window", 
												[
												(troop_remove_gold, "trp_player", 5),
												(play_sound, "snd_money_paid"),												
												]],

[anyone, "cantina_walkers_pre_brawl_4", [], "You'll be dead!", "close_window", 
										[
											(assign, "$tavern_brawl", 1),
											(assign, "$g_init_fight", 2),
											(call_script, "script_setup_tavern_brawl"),
										]
									],
											
######################## OTHER
		
[anyone|plyr, "cantina_walkers_generic_response", [], "I am going to knock you out for that comment!", "close_window", 
				[
					(assign, "$tavern_brawl", 1),
					(assign, "$g_init_fight", 2),
					(call_script, "script_setup_tavern_brawl"),
				]],
[anyone|plyr, "cantina_walkers_generic_response", [], "Sorry I bothered you, goodbye.", "close_window", []],


#SW - new cantina_walkers dialog
  # [anyone ,"start", 
		# [
			# (store_conversation_troop,reg(1)),
			# (ge,reg(1),cantina_walkers_begin),
			# (lt,reg(1),cantina_walkers_end)
		# ],
   # "I like to tell jokes when I am drunk. Want to hear one?", "cantina_walkers_talk",
   # []],

 # [anyone|plyr, "cantina_walkers_talk", [], "Sure.", "cantina_walkers_tell_joke", []],
 # [anyone|plyr, "cantina_walkers_talk", [], "No thanks, goodbye.", "close_window", []],   

 # #SW - cantina_walkers_tell_joke code from MartinF
 # [anyone, "cantina_walkers_tell_joke", [
    # (str_store_string, s10, "@Q:  What do you call a Sith who won't fight?^^A:  A Sithy."),
	# (str_store_string, s11, "@Q:  How is Ducktape like the Force?^^A:  It has a dark side, a light side and it binds the Galaxy together."),
    # (str_store_string, s12, "@Q:  How many stormtroopers does it take to replace a lightbulb?^^A:  Two, one to screw the bulb in, the other to shoot him and take the credit."),
	# (str_store_string, s13, "@Q:  What goes, 'Ha, ha, ha, haaaa.... AGGGHHHH! Thump'?^^A:  An Imperial Officer laughing at Darth Vader."),
	# (str_store_string, s14, "@Q:  Why did Yoda cross the road?^^A:  Because the chickens Forced him to."),
    # (str_store_string, s15, "@Q:  Why did the Ewok fall out of the tree?^^A:  It was dead."),
    # (str_store_string, s16, "@Q:  What do you call a person who brings a rancor its dinner?^^A:  The appetizer."),
    # (str_store_string, s17, "@Q:  Why do Doctors make the best Jedi?^^A:  Because a Jedi must have patience."),
    # (str_store_string, s18, "@Q:  What's the name of the worst cantina on Coruscant?^^A:  The Ackbar."),
    # (str_store_string, s19, "@Q:  What did the rancor say after he ate a Wookiee?^^A:  Chewie!"),
	
    # (store_random_in_range, ":random", 10, 20),
    # (str_store_string_reg, s4, ":random"),
   # ], "{s4}", "cantina_walkers_tell_joke", []
 # ],   
# [anyone|plyr, "cantina_walkers_tell_joke", [], "That was horrible.", "close_window", []],
# [anyone|plyr, "cantina_walkers_tell_joke", [], "Wow! You are a gifted comedian.", "close_window", []], 
...
#Tavernkeepers
  ...
  [anyone ,"start", [(store_conversation_troop,reg(1)),(ge,reg(1),tavernkeepers_begin),(lt,reg(1),tavernkeepers_end)],
   "Good day dear {sir/madam}. You look new here, so first, a word of advice. You will never find a more wretched hive of scum and villainy so you must be cautious. Anyway, how can I help you?", "tavernkeeper_talk",
   [
 ...
 Here, take these {reg5} credits. That should cover your pay.\
 And give {s9} my regards.\
 I'll put in a good word for you next time I deal with them.", "tavernkeeper_pretalk",
   [(quest_get_slot, ":quest_target_item", "qst_deliver_wine", slot_quest_target_item),
    (quest_get_slot, ":quest_target_amount", "qst_deliver_wine", slot_quest_target_amount),
 ...
 "Attacked by pirates, eh?\
 You're lucky they left you alive.\
 Anyway, I can pay you no more than {reg5} credits for this.\
...
#Tavern recruitment and ale START 2/2
  ...
  [anyone,"tavernkeeper_buy_peasants",
   [
       ...
       (lt, reg(5), -3),
    ], "I don't think anyone from this planet will follow somebody like you. Try your luck elsewhere.", "tavernkeeper_buy_peasants_2",[]],
...
#SW - Bounty Hunting Begin - http://forums.taleworlds.com/index.php/topic,59300.0.html
  [anyone|plyr,"tavernkeeper_talk", [(store_partner_quest,":tavernkeepers_quest"),
   ...
   "I want to make some money, are there any contracts available?", "tavernkeeper_request_mission_ask",[]],
  [anyone|plyr,"tavernkeeper_talk", [(store_partner_quest,":tavernkeepers_quest"),
                             (ge,":tavernkeepers_quest",0),],
   #"About the bounty you gave me...", "tavernkeeper_active_mission_1",[]],
   "About the contract you gave me...", "tavernkeeper_active_mission_1",[]],
  ...
  [anyone|plyr,"tavernkeeper_active_mission_2", [], "I am afraid I won't be able to do this contract.", "tavernkeeper_mission_failed",[]],
  ...
  It's good to know you can be trusted to handle things with an appropriate level of tactfulness.\
 A bounty I promised, and a bounty you shall have. 300 credits even!", "tavernkeeper_hunt_down_fugitive_success_2",
   [
     (add_xp_as_reward, 300),
    ]],
 ...
 An honorable sentiment, to be true.", "tavernkeeper_pretalk",[
       (call_script, "script_change_player_honor", 3),
       (call_script, "script_change_player_relation_with_troop", "$g_talk_troop", 2),
      (store_partner_quest,":tavernkeepers_quest"),
       (call_script, "script_end_quest", ":tavernkeepers_quest"),
 ...
 I thought you would be able to do this, {playername}. Clearly I was wrong.", "tavernkeeper_pretalk",
  ...
  [anyone,"tavernkeeper_tell_mission", [(eq,"$random_quest_no","qst_bounty_1")],
   "Actually there is one. It seems someone doesn't realize the Clone Wars are over. You know, the typical CIS officer, who goes by the name of {s4}. Anyway, he is assembling an army at {s3}, and the locals want something quick and clean. If you find, and elimiate him, you'll be given 300 credits.", "tavernkeeper_mission_hunt_down_fugitive_told",
   [
     (quest_get_slot, ":quest_target_center", "$random_quest_no", slot_quest_target_center),
     (quest_get_slot, ":quest_target_dna", "$random_quest_no", slot_quest_target_dna),
	 (str_store_troop_name,s9, "$g_talk_troop"),	#modified
     (str_store_party_name_link,s3, ":quest_target_center"),
	 (str_store_party_name_link,s5, "$current_town"),	#new
     (call_script, "script_get_name_from_dna_to_s50", ":quest_target_dna"),
     (str_store_string, s4, s50),
     (setup_quest_text, "$random_quest_no"),
	 (str_store_string, s2, "@The {s9} at {s5} asked you to eliminate a CIS officer named {s4}. They are currently believed to be at {s3}."),	#modified
   ]],
  [anyone,"tavernkeeper_tell_mission", [(eq,"$random_quest_no","qst_bounty_2")],
   "Yes, and nothing very complicated. A simple farmer named {s4} who has a territorial dispute with a local businessman at {s3}. He is armed, but is not really dangerous. You go, you finish him, and you return for your payment. It will be 300 credits once finished.", "tavernkeeper_mission_hunt_down_fugitive_told",
   [
     (quest_get_slot, ":quest_target_center", "$random_quest_no", slot_quest_target_center),
     (quest_get_slot, ":quest_target_dna", "$random_quest_no", slot_quest_target_dna),
	 (str_store_troop_name,s9, "$g_talk_troop"),	#modified
     ...
     (str_store_string, s4, s50),
     (setup_quest_text, "$random_quest_no"),
	 (str_store_string, s2, "@The {s9} at {s5} asked you to hunt down a farmer named {s4}. They are currently believed to be at {s3}."),	#modified
   ]],
  [anyone,"tavernkeeper_tell_mission", [(eq,"$random_quest_no","qst_bounty_3")],
   "Yes. And it seems it's something special this time because there is no customer, and no why. The target you would have to eliminate is called {s4} and is now on {s3}. I've been told he is ready to face anything and the payment for this job is 300 credits.", "tavernkeeper_mission_hunt_down_fugitive_told",
   [
     (quest_get_slot, ":quest_target_center", "$random_quest_no", slot_quest_target_center),
     (quest_get_slot, ":quest_target_dna", "$random_quest_no", slot_quest_target_dna),
	 (str_store_troop_name,s9, "$g_talk_troop"),	#modified
     ...
     (str_store_string, s4, s50),
     (setup_quest_text, "$random_quest_no"),
	 (str_store_string, s2, "@The {s9} at {s5} asked you to hunt down a target named {s4}. They are currently believed to be at {s3}."),	#modified
   ]],
  [anyone,"tavernkeeper_tell_mission", [(eq,"$random_quest_no","qst_bounty_4")],
   "Yeah, there is. An issue with a pirate named {s4}. It seems that his gang was intercepted during some sort of sabotage but he managed to get to an escape pod. He has been causing problems for the locals at {s3} ever since. The price is 300 credits.", "tavernkeeper_mission_hunt_down_fugitive_told",
   [
     (quest_get_slot, ":quest_target_center", "$random_quest_no", slot_quest_target_center),
     (quest_get_slot, ":quest_target_dna", "$random_quest_no", slot_quest_target_dna),
	 (str_store_troop_name,s9, "$g_talk_troop"),	#modified
  ...
  [anyone,"tavernkeeper_tell_mission", [(eq,"$random_quest_no","qst_bounty_5")],
   ...
   [
     ...
     (str_store_string, s4, s50),
     (setup_quest_text, "$random_quest_no"),
	 (str_store_string, s2, "@The {s9} at {s5} asked you to hunt down a bountyhunter named {s4}. They are currently believed to be at {s3}."),	#modified
   ]],
  [anyone,"tavernkeeper_tell_mission", [(eq,"$random_quest_no","qst_bounty_6")],
   "Yeah, a Hutt is quite upset at a smuggler named {s4}. Apparently he dropped his cargo right before being boarded by some Imperials... anyway, he's believed to be at {s3} and the reward is 300 credits.", "tavernkeeper_mission_hunt_down_fugitive_told",
   [
     (quest_get_slot, ":quest_target_center", "$random_quest_no", slot_quest_target_center),
     (quest_get_slot, ":quest_target_dna", "$random_quest_no", slot_quest_target_dna),
	 (str_store_troop_name,s9, "$g_talk_troop"),	#modified
     ...
     (str_store_string, s4, s50),
     (setup_quest_text, "$random_quest_no"),
	 (str_store_string, s2, "@The {s9} at {s5} asked you to hunt down a smuggler named {s4}. They are currently believed to be at {s3}."),	#modified
   ]],

  [anyone,"tavernkeeper_tell_mission", [],
   #"I'm sorry, but I don't have any bounties for you right now.", "tavernkeeper_pretalk",[]],
   "I'm sorry, but I don't have any contracts for you right now.", "tavernkeeper_pretalk",[]],
  ...
  [anyone|plyr,"tavernkeeper_mission_hunt_down_fugitive_told", [],
   ...
   "I will claim this contract.", "tavernkeeper_mission_hunt_down_fugitive_accepted",[]],
  ...
  [anyone,"tavernkeeper_mission_hunt_down_fugitive_accepted", [], "That's excellent, {playername}. The customer will be so grateful to have them....found. Once you deal with this just return here for your reward. Well, good hunting to you.", "close_window",
   [(call_script, "script_start_quest", "$random_quest_no", "$g_talk_troop"),
    (call_script, "script_change_player_relation_with_troop","$g_talk_troop",3),
    (assign, "$g_leave_encounter",1),
   ]],
...
##   []],
##  [anyone,"tavernkeeper_rest", [], "Of course... That will be {reg3} credits for the room and food. How long do you want to rest?", "tavernkeeper_rest_2",
...
##plus
  ...
  [anyone|plyr,"tavernkeeper_talk",
   ...
   "Do you want to play Pazaak?", "tavernkeeper_blackjack_1",[]],
  [anyone,"tavernkeeper_blackjack_1",
   [],
   "Sure. Are you ready to play or should I review the rules?", "tavernkeeper_blackjack_2",[]],
  ...
  [anyone|plyr,"tavernkeeper_blackjack_2",
   [],
   "Discuss the rules.", "tavernkeeper_blackjack_4",[]],
  [anyone,"tavernkeeper_blackjack_4",
   [],
   #"Blackjack Rules 1", "tavernkeeper_blackjack_5",[]],
   "Pazaak is played with the same rules as Blackjack. The player closest to 21, without going over, wins.", "tavernkeeper_blackjack_1",[]],
  ...
  # "Nothing.", "tavernkeeper_pretalk",[]],
    [anyone|plyr,"tavernkeeper_blackjack_2",[],"Never mind.", "tavernkeeper_pretalk",[]],
## end plus
# END OF BLACKJACK MOD
  ...
  [anyone,"tavernkeeper_buy_drinks",
   [
    ], "Of course, {sir/madam}. I reckon {reg5} credits should be enough for that. What should I tell the lads?", "tavernkeeper_buy_drinks_2",[
        (assign, "$temp", 1000),
        (assign, reg5, "$temp"),
        ]],
  ...
  [anyone,"tavernkeeper_buy_drinks_end",
   ...
   [], "Don't worry. Your name will be cheered and toasted here all night.", "tavernkeeper_pretalk",
   [
  ...
  [anyone|plyr,"tavernkeeper_talk", [
      ...
      (val_sub, ":cur_hours", 24),
      (gt, ":cur_hours", "$buy_drinks_last_time"),
      ], "I'd like to buy me and my troops a barrel of your best ale.", "tavernkeeper_buy_drinks_troops",[]],

  [anyone,"tavernkeeper_buy_drinks_troops",
   [
    ], "Of course, {sir/madam}. I reckon {reg5} credits should be enough for that. What should I tell the lads?", "tavernkeeper_buy_drinks_troops_2",[
        (assign, "$temp", 20),
  ...
  [anyone|plyr,"tavernkeeper_buy_drinks_troops_2",
   [
        ...
        (ge, ":gold", "$temp"),
        (str_store_party_name, s10, "$current_town"),
    ], "That this is reward for their efforts thus far. Let them have at it.", "tavernkeeper_buy_drinks_troops_end",[
       
        ]],

  [anyone,"tavernkeeper_buy_drinks_troops_end",
   #[], "Don't worry {sir/madam}. Your troops will enjoy their pints.", "tavernkeeper_pretalk",
   [], "Don't worry. Your troops will enjoy their pints.", "tavernkeeper_pretalk",
   [
       (troop_remove_gold, "trp_player", "$temp"),
...
#  [anyone, "companion_recruit_yes", [(neg|hero_can_join, "p_main_party"),], "I don't think can lead any more troops than you do now.\
...
#Tavern Talk (with ransom brokers)
 ...
 And you look like the type who might have a prisoner to sell.", "ransom_broker_info_talk",[(assign, "$ransom_broker_families_told",0),
  ...
  [anyone, "ransom_broker_families", [], "Oh, then I spin them a few heartwarming tales of life in the engine rooms of the great fleets of this Galaxy.\
 You'd be surprised what sorts of treasures a farmer can dig out of his nerf hut or wheedle out of his cousins,\
 assuming he's got the proper motivation!\
 And if in the end they cannot come up with the credits, then there are always slave merchants who are looking for engine slaves.\
 One cannot survive in this Galaxy with an empty credit account, you see.", "ransom_broker_info_talk",[(assign, "$ransom_broker_families_told",1)]],
 ...
 The real credits to be made, of course, are in the gentry, and if you ever want to do my job you'll want to learn about every important family in the Galaxy,\
 their planets, their heraldry, their offspring both lawful and bastard, and, of course, their credit with the merchants.", "ransom_broker_info_talk",[(assign, "$ransom_broker_prices_told",1)]],
  ...
  [anyone, "ransom_broker_ransom_me", [], "Of course. I'm welcome on every planet in the Galaxy.\
 There's not many who can say that! So always be sure to keep a credit chip or two somewhere,\
 and a loyal servant who can find it in a hurry.", "ransom_broker_info_talk",[(assign, "$ransom_broker_ransom_me_told",1)]],
  ...
  [anyone|plyr,"ransom_broker_talk",
   [[store_num_regular_prisoners,reg(0)],[ge,reg(0),1]],
   "Then you'd better bring your credits. I have got prisoners to sell.", "ransom_broker_sell_prisoners",[]],
...
#Tavern Talk (with travelers)
 ...
 I can provide you information that you might find useful. For a small price of course.", "tavern_traveler_talk", [(assign, "$traveler_land_asked", 0)]],
  ...
  [anyone, "tavern_traveler_tell_factions", [], "The Galaxy is divided between Emperor Palpatine's Empire and Mon Mothma's Rebel Alliance, both fighting for control.\
 ...
 What's worse is that the Hutt Cartel grows stronger each day and plans to contend the major powers with its own forces!\
 ...
 but in time of war, a commander will not hesitate to accept someone who distinguishes {himself/herself} on the battlefield as a commander, and grant {him/her} the right to own planets.",
   "tavern_traveler_tell_factions_5", []],
 ...
 # If those claim holders could find supporters, they could easily start their civil wars and perhaps even replace the leader one day.",
  ...
  [anyone|plyr, "tavern_traveler_tell_factions_5", [], "I guess I've heard enough already. Thank you.", "close_window", []],
 ...
 # But of course, I would ask for a little something for such a service.",
  ...
  [anyone, "tavern_traveler_companion_location", [], "The Galaxy is a large place. But maybe I can help you. Who are you looking for?", "tavern_traveler_companion_location_ask", []],
  ...
  [anyone, "tavern_traveler_companion_location_ask_2", [(str_store_troop_name, s15, "$temp")], "I guess I know where {s15} is. For 30 credits, I'll tell you.", "tavern_traveler_companion_location_ask_money", []],

  [anyone|plyr, "tavern_traveler_companion_location_ask_money",
   [
     (store_troop_gold, ":cur_gold", "trp_player"),
     (ge, ":cur_gold", 30),
     ], "All right. Here is 30 credits.", "tavern_traveler_companion_location_tell",
   [
     (troop_remove_gold, "trp_player", 30),
     ]],
  ...
  [anyone, "start", [(is_between, "$g_talk_troop", tavern_travelers_begin, tavern_travelers_end),
   ...
   "Greetings. They say you're the kind of {man/woman} who'd be interested to hear that I travel frequently to {s17}. I'll tell you all I know for a mere 100 credits.", "tavern_traveler_answer", []],

  [anyone|plyr, "tavern_traveler_answer", [(store_troop_gold, ":cur_gold", "trp_player"),
                                            (ge, ":cur_gold", 100)],
   "Here's 100 credits. Tell me what you know.", "tavern_traveler_continue", [(party_get_slot, ":info_faction", "$g_encountered_party", slot_center_traveler_info_faction),
...
#Tavern Talk (with book sellers)
   #SW - modified bookseller dialog
   ############# FORCE SENSITIVE DIALOG #####################################
  [anyone, "start", [(is_between, "$g_talk_troop", tavern_fs_trainer_begin, tavern_fs_trainer_end),
                     ],
 "Hello there, I sense you have some ability with the force. I can train you but would ask for a small donation. Are you interested?", "fs_bookseller_talk", []],
  [anyone|plyr, "fs_bookseller_talk", [], "Yes, show me what I could learn.", "fs_bookseller_buy", []],
   
  [anyone,"fs_bookseller_buy", [], "Of course.", "fs_book_trade_completed",[[change_screen_trade]]],
  [anyone,"fs_book_trade_completed", [], "Anything else?", "fs_bookseller_talk",[]],

  [anyone|plyr,"fs_bookseller_talk", [], "Not right now. Thanks.", "close_window",[]],   
   ############# FORCE SENSITIVE DIALOG #####################################
   #############  GENERIC DIALOG #####################################
  [anyone, "start", [
					(is_between, "$g_talk_troop", tavern_booksellers_begin, tavern_booksellers_end),
					(neg|is_between, "$g_talk_troop", tavern_fs_trainer_begin, tavern_fs_trainer_end),
                    ],
 #"Good day {sir/madam}, I have several items for sale if you are interested?", "bookseller_talk", []],
 "Good day, I have several items for sale if you are interested?", "bookseller_talk", []],
...
#Tavern Talk (with farmers)
  [anyone, "start", [(eq, "$talk_context", tc_tavern_talk),
   ...
   "You look like a {man/lady} of honor and someone who could help us.\
 ...
 If one of us so much as breathes a word of protest, they kill the poor soul without hesitation.\
 ...
 If there is anyone who can help us, it's you.", "farmer_from_bandit_minorplanet_5", [(assign, "$temp", 0)]],
  ...
  [anyone, "farmer_from_bandit_minorplanet_accepted", [],
   ...
   [(quest_get_slot, ":target_center", "qst_eliminate_bandits_infesting_village", slot_quest_target_center),
    ...
    (str_store_string, s2, "@A citizen from {s7} begged you to save their planet from the pirates that took refuge there."),
 ...
 We will forever express our gratitude if you help us.", "farmer_from_bandit_minorplanet_5", [(assign, "$temp", 1)]],
  ...
  [anyone, "start", [(eq, "$talk_context", tc_tavern_talk),
   ...
   "Thank you for helping us {sir/madam}. Crush those pirates!", "close_window", []],
...
#Tavern Talk (with troops)
 ...
 We'll join you for {reg5} credits.", "mercenary_tavern_talk", []],
  ...
  [anyone|plyr, "mercenary_after_recruited", [],
   "Make your preparations. See you back at the ship.", "mercenary_after_recruited_2", []],
  [anyone|plyr, "mercenary_after_recruited", [],
   "Take your time. We'll be staying on this planet for a while.", "mercenary_after_recruited_2", []],
  ...
  [anyone|plyr, "mercenary_tavern_talk", [(party_get_slot, ":mercenary_amount", "$g_encountered_party", slot_center_mercenary_troop_amount),
   ...
   "All right. I will hire all of you. Here is {reg5} credits.", "mercenary_tavern_talk_hire", []],
  ...
  [anyone|plyr, "mercenary_tavern_talk", [(party_get_slot, ":mercenary_amount", "$g_encountered_party", slot_center_mercenary_troop_amount),
   ...
   "All right. But I can only hire {reg6} of you. Here is {reg5} credits.", "mercenary_tavern_talk_hire", []],
  ...
  [anyone, "mercenary_tavern_talk_hire", [(store_random_in_range, ":rand", 0, 4),
                                          ...
                                          (else_try),
                                            (eq, ":rand", 1), 
                                            (str_store_string, s17,
                                             "@Well done, {sir/madam}. Keep the credits and wine coming our way, and there's no foe in the Galaxy you need fear."),
                                          (else_try),
                                            (eq, ":rand", 2), 
                                            (str_store_string, s17,
                                          ...
                                          (else_try),
                                            (str_store_string, s17,
                                             "@You will not be disappointed {sir/madam}. You will not find better warriors in all of the Galaxy."),
                                          (try_end),],
   "{s17}", "close_window", [
                                          (party_get_slot, ":mercenary_troop", "$g_encountered_party", slot_center_mercenary_troop_type),
                                          (call_script, "script_game_get_join_cost", ":mercenary_troop"),
  ...
  [anyone|plyr, "mercenary_tavern_talk", [(eq, "$temp", 0),
                                          (party_get_free_companions_capacity, ":free_capacity", "p_main_party"),
                                          (ge, ":free_capacity", 1)],
   "That sounds good. But I can't afford to hire any more troops right now.", "tavern_mercenary_cant_lead", []],
 ...
 if you need to hire anyone.", "close_window", []],
  ...
  [anyone|plyr, "mercenary_tavern_talk", [(eq, "$temp", 0),
                                          (party_get_free_companions_capacity, ":free_capacity", "p_main_party"),
                                          (eq, ":free_capacity", 0)],
   "That sounds good. But I can't lead any more troops right now.", "tavern_mercenary_cant_lead", []],


  [anyone|plyr, "mercenary_tavern_talk", [],
   "Sorry. I don't need any other troops right now.", "close_window", []],

#Trainers
  [anyone,"start", [(is_between, "$g_talk_troop", training_gound_trainers_begin, training_gound_trainers_end),
                    (eq, "$g_talk_troop_met", 0)],
   "Good day to you {lad/lass}. You look like another adventurer who has come to try {his/her} chance in this Galaxy.\
...
##   "I have some novice soldiers with me. Can you train them?", "trainer_train_novices_1",[]],
   ...
   "What else do you want to know?", "trainer_talk_combat",[]],
    ...
    [anyone|plyr,"trainer_talk_combat", [], "Tell me about fighting on a speeder.", "trainer_explain_horseback",[]],
...
#    [anyone|plyr,"trainer_talk_combat", [], "Tell me about weapon types.", "trainer_explain_weapon_types",[]],
 ...
 Anyone can swing a vibro-sword around and hope to cut some flesh, but only those fighters that are experts at defense live to tell of it.",
	"trainer_explain_defense_2",[]],
  [anyone,"trainer_explain_defense_2", [], "Now. Defending yourself is easiest if you are equipped with some kind of shield.\
 ...
 If you start to block BEFORE he makes his move, he may just attack in another direction than the one you are blocking against and score a hit.", "trainer_combat_pretalk",[]],
  [anyone,"trainer_explain_attack", [], "Good question. Attacking is the best defense, they say.\
 ...
 [to control your swing direction with default controls, move your mouse in the direction you want to swing from as you press the left mouse button].", "trainer_combat_pretalk",[]],
  [anyone,"trainer_explain_horseback", [], "Very good question. A speeder may be a warrior's most powerful weapon in combat.\
 It gives you speed, height, power and initiative. A lot of deadly weapons will become even deadlier while on a speeder.\
 However you must pay particular attention to speeder-mounted enemies couching their lances, as they may take down any opponent in one hit.\
 [To use the couched lance yourself, wield a lance or similar weapon, and speed up your speeder without pressing attack or defense buttons.\
 after you reach a speed, you'll lower your lance. Then try to target your enemies by maneuvering your speeder.]", "trainer_combat_pretalk",[]],
...
## But don't worry. No one knows it is {playername} under that hood. Except me of course. But I am {s1}. It is my business to know things.", "crook_intro_sneak_3",[]],
...
## I led him to this fugitive, and the man was worth his weight in Bassel sea salt as prize money. But I swear, I didn't see a credit of it.\
...
## I wouldn't want you to survive this one as well and then come after me with a blaster. Ha-hah.", "crook_talk",[]],
##
##
...
#   "Alright but this will cost you 50 credits.", "crook_enter_dungeon_2", []],

#  [anyone|plyr, "crook_enter_dungeon_2", [(store_troop_gold, ":cur_gold", "trp_player"),
#                                            (ge, ":cur_gold", 50)],
#   "TODO: Here it is. 50 credits.", "crook_enter_dungeon_3_1",[(troop_remove_gold, "trp_player", 50)]],
...
##   "Alright but this will cost you 50 credits.", "crook_request_meeting_4", []],
##
##  [anyone|plyr, "crook_request_meeting_4", [(store_troop_gold, ":cur_gold", "trp_player"),
##                                            (ge, ":cur_gold", 50)],
##   "TODO: Here it is. 50 credits.", "crook_search_person_5_1",[(troop_remove_gold, "trp_player", 50)]],
##
##  [anyone|plyr, "crook_request_meeting_4", [(store_troop_gold, ":cur_gold", "trp_player"),
##                                            (ge, ":cur_gold", 50)],
##   "Never mind then.", "crook_pretalk",[]],
...
##   "TODO: I know where {s1} is at the moment, but hearing it will cost you 50 credits.", "crook_search_person_6",[]],
##
...
##                                          (ge, ":cur_gold", 50)],
##   "TODO: Here it is. 50 credits.", "crook_search_person_7_1",[(troop_remove_gold, "trp_player", 50)]],
##
##  [anyone|plyr, "crook_search_person_6", [(store_troop_gold, ":cur_gold", "trp_player"),
##                                          (ge, ":cur_gold", 50)],
##   "Never mind then.", "crook_pretalk",[]],
...
#Mayor talk (town elder)
  ...
  [anyone ,"start", [(is_between,"$g_talk_troop",mayors_begin,mayors_end),(eq,"$g_talk_troop_met",0),
   ...
   "Hello stranger, you seem to be new to {s9}. I am the administrator of this planet.", "mayor_talk",[]],
 ...
 Your involvement has not only saved our planet from disaster, but it has also saved thousands of lives, and put an end to all the grief this bitter war has caused.\
 As the citizens of {s19}, know that we'll be good on our word, and we are ready to pay the {reg12} credits we promised.", "lord_persuade_lords_to_make_peace_completed",
   [(quest_get_slot, ":quest_target_faction", "qst_persuade_lords_to_make_peace", slot_quest_target_faction),
    (quest_get_slot, ":quest_object_faction", "qst_persuade_lords_to_make_peace", slot_quest_object_faction),
 ...
 Here, please accept these {reg12} credits together with our most sincere thanks.\
 Me and the people of this planet will not forget your help.", "close_window",
   [(quest_get_slot, ":quest_reward", "qst_persuade_lords_to_make_peace", slot_quest_gold_reward),
  ...
  [anyone ,"lord_persuade_lords_to_make_peace_no_pay", [],
   "You are indeed an extraordinary person, {sir/madame}, and it is an honor for me to have known you.\
...
# Ryan END
  ...
  [anyone,"mayor_begin", [(check_quest_active, "qst_move_cattle_herd"),
   ...
   "Good to see you again {playername}. I have heard that you have delivered the nerfs successfully.\
 I will tell the merchants how reliable you are.\
 And here is your pay, {reg8} credits.", "close_window",
  ...
  [anyone,"mayor_begin", [(check_quest_active, "qst_move_cattle_herd"),
   ...
   "I heard that you have lost the nerf herd on your way to {s9}.\
 ...
 You should know that the owner of the herd demanded to be compensated for his loss, and I had to pay him 1000 credits.\
 So you now owe me that money.", "merchant_ask_for_debts",
  ...
  Please take these {reg8} credits that I promised you.\
  My friend wished he could give more but paying that ransom almost bankrupt them.", "close_window",
  ...
  [anyone,"mayor_begin", [(check_quest_active, "qst_troublesome_bandits"),
   ...
   "I have heard about your deeds. You have given those pirates the punishment they deserved.\
 You are really as good as they say.\
 Here is your reward: {reg5} credits.\
 I would like to give more but those pirates almost brought me to bankruptcy.",
  ...
  [anyone,"mayor_begin", [(ge, "$debt_to_merchants_guild", 50)],
   "According to my accounts, you owe the merchants guild {reg1} credits.\
 ...
 Come back when you can pay the {reg1} credits.\
 ...
 So the sooner you pay it, the better.", "close_window",[]],
  ...
  [anyone, "mayor_info_begin", [(str_store_party_name, s9, "$current_town")],
   "I am the administrator of {s9}. You could say I am the leader of the good people of {s9}.\
...
# Ryan END
 ...
 Perhaps you can do that...", "merchant_quest_brief",
  ...
  [anyone,"merchant_quest_brief", [(eq,"$random_merchant_quest_no","qst_deliver_wine")],
   "I have a cargo of {s6} that needs to be delivered to the cantina in {s4}.\
 If you can take {reg5} units of {s6} to {s4} in 7 days, you may earn {reg8} credits.\
 What do you say?", "merchant_quest_brief_deliver_wine",
   [(quest_get_slot, reg5, "qst_deliver_wine", slot_quest_target_amount),
    ...
    (str_store_string, s2, "@{s9} of {s3} asked you to deliver {reg5} units of {s6} to the cantina in {s4} in 7 days."),
  ...
  [anyone|plyr,"merchant_quest_brief_deliver_wine", [], "I'm afraid I can't carry all that cargo now.", "merchant_quest_stall",[]],

#escort merchant caravan:
  [anyone,"merchant_quest_requested", [(eq,"$random_merchant_quest_no","qst_escort_merchant_caravan")], "You're looking for a job?\
 Actually I was looking for someone to escort a merchant fleet.\
 Perhaps you can do that...", "merchant_quest_brief",
   []],

  [anyone,"merchant_quest_brief", [(eq, "$random_merchant_quest_no", "qst_escort_merchant_caravan")],
   "I am going to send a fleet of goods to {s8}.\
 However with all those pirates and deserters patrolling the trade routes, I don't want to send them out without an escort.\
 If you can lead that fleet to {s8} in 15 days, you will earn {reg8} credits.\
 Of course your party needs to be at least {reg4} strong to offer them any protection.", "escort_merchant_caravan_quest_brief",
  ...
  [anyone|plyr,"escort_merchant_caravan_quest_brief", [(store_party_size_wo_prisoners, ":party_size", "p_main_party"),
   ...
   "Alright. I'll escort the fleet.", "merchant_quest_taken",
   [(quest_get_slot, ":quest_target_center", "qst_escort_merchant_caravan", slot_quest_target_center),
    (set_spawn_radius, 1),
    ...
    (str_store_string, s2, "@Escort the merchant fleet to the planet of {s8}."),
 ...
 Thanks for escorting us. Good luck.", "close_window",[(quest_get_slot, ":quest_target_party", "qst_escort_merchant_caravan", slot_quest_target_party),
  ...
  [anyone,"merchant_caravan_follow_lead", [], "Alright. We'll be right behind you.", "close_window",[(assign, "$escort_merchant_caravan_mode", 0),
                                                                                                     (assign, "$g_leave_encounter", 1)]],
  [anyone|plyr,"escort_merchant_caravan_talk", [], "You stay here for a while. I'll go ahead and scout this quadrant.", "merchant_caravan_stay_here",[]],
...
# Troublesome bandits:
 ...
 They have been waiting in orbit of the planet and are preying on my merchant fleets.\
 ...
 If someone doesn't stop them soon, I am going to be ruined...", "merchant_quest_brief",
  ...
  "I will pay you {reg8} credits if you hunt down those troublesome bandits.\
 ...
 What do you say?", "troublesome_bandits_quest_brief",[(quest_get_slot, reg8, "qst_troublesome_bandits", slot_quest_gold_reward),
  ...
  [anyone|plyr,"troublesome_bandits_quest_brief", [],
   ...
   [(set_spawn_radius,7),
    ...
    (str_store_string, s2, "@Merchant {s9} of {s4} asked you to hunt down the troublesome bandits in the vicinity of their planet."),
...
# Kidnapped girl:
 ...
 someone to take the money to those villains and bring the girl back to safety.", "merchant_quest_brief",
   []],

  [anyone,"merchant_quest_brief", [(eq, "$random_merchant_quest_no", "qst_kidnapped_girl")],
  #SW - modified village to planet in dialogs
  "The amount the bandits ask as ransom is {reg12} credits.\
 I will give you that money once you accept to take the quest.\
 You have 15 days to take the money to the bandits who will be waiting in orbit of planet {s4}.\
 They've said they'll kill the girl if they don't get the money in that time.\
 You will be paid {reg8} credits when you bring the girl safely back here.",
  ...
  [anyone|plyr,"kidnapped_girl_quest_brief", [],
      "Okay. Give me the ransom money and I'll get you the girl.",
   "kidnapped_girl_quest_taken",[(set_spawn_radius, 4),
                                 ...
                                 (str_store_string, s2, "@Administrator of {s4} gave you {reg12} credits to pay the ransom of a girl kidnapped by bandits.\
 ...
 Here's the ransom money, {reg12} credits.\
 Count it before taking it.\
 And please, don't attempt any heroics.\
 The girl's safety is the main concern.", "close_window",
   []],
  ...
  I can't wait to see my family. Perhaps we shall meet again some day? Good-bye.",
   "close_window",
 ...
 Also, I want back that {reg8} credits I gave you as the ransom fee.", "lost_kidnapped_girl_4",
...
#persuade_lords_to_make_peace
  [anyone,"merchant_quest_requested", [(eq, "$random_merchant_quest_no", "qst_persuade_lords_to_make_peace"),
   ...
   "This war between {s15} and {s14} has brought our planet to the verge of ruin.\
 Our trade fleets get raided before they can reach their destination.\
 Our merchants are afraid to leave the safety of the planet shields.\
 ...
 If peace does not come soon, we can not hold on for much longer.", "merchant_quest_persuade_peace_1",
  ...
  [anyone|plyr,"merchant_quest_persuade_peace_1", [], "It is your duty to help the rulers in their war effort. You shouldn't complain about it.", "merchant_quest_persuade_peace_reject",[]],

  [anyone,"merchant_quest_persuade_peace_reject", [], "Hah. The rulers fight their wars for their greed and their dreams of glory.\
 ...
 But you obviously don't want to hear about that.", "close_window",[]],
  ...
  [anyone,"merchant_quest_brief", [(eq,"$random_merchant_quest_no","qst_persuade_lords_to_make_peace")],
   "There have been attempts to reconcile the two sides and reach an agreement.\
 However, there are powerful lords on both sides whose interests lie in continuing the war.\
 These troops urge all others not to heed to the word of sensible troops, but to keep fighting.\
 While these leaders remain influential, no peace agreement can be reached.", "merchant_quest_persuade_peace_3",[]],
 ...
 there will be no chance of having peace between the two sides.", "merchant_quest_persuade_peace_5",[
  ...
  [anyone|plyr,"merchant_quest_persuade_peace_5", [], "Sadly however, it seems nothing can be done about it.", "merchant_quest_persuade_peace_6",[]],
 ...
 If they are captive, they will lose their influence and they can no longer oppose an agreement... What do you think? Can you do it?",
  ...
  [anyone,"merchant_quest_persuade_peace_8", [], "Most of the merchants on the planet will gladly dig into their bank accounts to support such a plan.\
 I think we can collect {reg12} credits between ourselves.\
 We will be happy to reward you with that sum, if you can work this out.\
 Convince {s12} and {s13} to accept peace,\
 and if either of them proves too stubborn, make sure they fall captive and can not be ransomed until a peace deal is settled.",
 ...
 We will be waiting and hoping for the good news.", "close_window",[
     ...
     (str_store_string, s2, "@Administrator of {s4} promised you {reg12} credits if you can make sure that\
 {s12} and {s13} no longer pose a threat to peace between {s15} and {s14}.\
...
#deal with night bandits
  [anyone,"merchant_quest_requested",
   ...
   "Do I indeed! There's a group of bandits infesting the planet, and I'm at the end of my rope as to how to deal with them.\
 They've been ambushing and robbing citizens under the cover of night,\
 ...
 Are you up to the task?", "merchant_quest_deal_with_night_bandits",
  ...
  [anyone,"merchant_quest_brief",
   ...
   "There's a group of bandits infesting the planet, and I'm at the end of my rope as to how to deal with them.\
 They've been ambushing and robbing citizens under the cover of night,\
 and then fading away quick as lightning when the guards finally show up. We've not been able to catch a one of them.\
 They only attack lone people, never daring to show themselves when there's a group about.\
 I need someone who can take on these bandits alone and win. That seems to be the only way of bringing them to justice.\
 Are you up to the task?", "merchant_quest_deal_with_night_bandits",
  ...
  [anyone|plyr,"merchant_quest_deal_with_night_bandits", [],
   ...
   [
     ...
     (str_store_string, s2, "@The Administrator of {s14} has asked you to deal with a group of bandits terrorizing the streets of {s14}. They only come out at night, and only attack lone travelers on the streets."),
...
#move cattle herd
  [anyone,"merchant_quest_requested", [(eq, "$random_merchant_quest_no", "qst_move_cattle_herd"),
   ...
   "One of the merchants here is looking for a nerf herder to take his nerfs to the market at {s13}.", "merchant_quest_brief",
   []],
  ...
  [anyone,"merchant_quest_brief",
   ...
   "The nerf herd must be at {s13} within 30 days. Sooner is better, much better,\
 but it must be absolutely no later than 30 days.\
 If you can do that, I'd be willing to pay you {reg8} credits for your trouble. Interested?", "move_cattle_herd_quest_brief",
   []],
  
  [anyone|plyr,"move_cattle_herd_quest_brief", [],  "Okay, I'll take the nerfs to {s13}.",
   ...
   [
     ...
     (str_store_string, s2, "@Administrator of {s10} asked you to move a nerf herd to {s13}. You will earn {reg8} credits in return."),
  ...
  [anyone,"move_cattle_herd_quest_taken", [], "Splendid. You can find the herd in orbit above the planet.\
...
#   "Now, good {sire/lady}, is there anything I can do for you?", "minorplanet_elder_talk",[]],
  ...
  [anyone,"start", [(is_between,"$g_talk_troop", planet_admins_begin, planet_admins_end),(eq,"$g_talk_troop_met",0),
   ...
   "Welcome to {s9}, {playername}. We were notified that you are the new {commander/commander} of our minor planet.\
 I am the planet administrator and I will assist you in any way I can.", "minorplanet_elder_talk",[]],
  
  [anyone ,"start", [(is_between,"$g_talk_troop",planet_admins_begin,planet_admins_end),
                     (party_slot_eq, "$current_town", slot_mainplanet_lord, "trp_player")],
   "{My commander/My commander}, you honor our minor planet with your presence.", "minorplanet_elder_talk",[]],
  ...
  [anyone,"minorplanet_elder_tell_enemies",
   [
     ...
     (try_for_range, ":cur_troop", faction_heroes_begin, ":end_cond"),
       ...
       (assign, ":end_cond", 0),
       (str_store_string, s2, "@He is not commanding any troops at the moment."),
       (assign, ":num_troops", 0),
       ...
       (str_store_string, s2, "@He currently commands {reg0} troops{reg1?, of which around {reg1} are wounded:}."),
     (try_end),
     (eq, ":end_cond", 0),
     ],
...
#Goods Merchants
  ...
  [anyone ,"start", [(is_between,"$g_talk_troop",goods_merchants_begin,goods_merchants_end),
                     (party_slot_eq, "$current_town", slot_mainplanet_lord, "trp_player")],
   "You honor my humble shop with your presence.", "goods_merchant_talk",[]],
  [anyone ,"start", [(is_between,"$g_talk_troop",goods_merchants_begin,goods_merchants_end)],
...
#  [anyone,"merchant_begin", [], " What can I do for you?", "goods_merchant_talk",[]],
  ...
  [anyone|plyr,"goods_merchant_talk", [], "What goods should I buy here to trade with other planets?", "trade_info_request",[]],

  [anyone|plyr,"goods_merchant_talk", [], "Nothing. Thanks.", "close_window",[]],

  [anyone,"trade_info_request", [], "That information can be best obtained from convoy masters\
 and traveling merchants. If you want I can send you to the district where foreign merchants stay at when they come to the planet.\
...
#  [anyone|plyr,"goods_merchant_talk", [], "What do convoys buy and sell in this town?", "goods_merchant_town_info",[]],
...
#############################################################################
 ...
 Everyone from the planet comes here. The crowd becomes mad with excitement.\
 ...
 Sounds like fun, eh?", "arena_training_melee_intro_2",[]],
  ...
  [anyone,"arena_training_melee_intro_reward", [(assign, reg1, arena_tier1_opponents_to_beat),(assign, reg11, arena_tier1_prize),
    ...
    ], "There is, actually. Some of the wealthy citizens offer prizes for those fighters who show great skill in the fights.\
 If you can beat {reg1} opponents before going down, you'll earn {reg11} credits. You'll get {reg12} credits for striking down at least {reg2} opponents,\
 {reg13} credits if you can defeat {reg3} opponents, and {reg14} credits if you can survive long enough to beat {reg4} opponents.\
 If you can manage to be the last {man/fighter} standing, you'll earn the great prize of the fights, {reg15} credits. Sounds good, eh?", "arena_training_melee_intro_2",[(assign, "$arena_tournaments_asked", 1),]],
  [anyone,"arena_training_melee_explain_reward", [
      ...
      (assign, reg4, arena_tier4_opponents_to_beat),(assign, reg14, arena_tier4_prize),
      (assign, reg15, arena_grand_prize)
      ], "Some of the wealthy citizens offer prizes for those fighters who show great skill in the fights.\
 If you can beat {reg1} opponents before going down, you'll earn {reg11} credits. You'll get {reg12} credits for striking down at least {reg2} opponents,\
 {reg13} credits if you can defeat {reg3} opponents, and {reg14} credits if you can survive long enough to beat {reg4} opponents.\
 If you can manage to be the last {man/fighter} standing, you'll earn the great prize of the fights, {reg15} credits. Sounds good, eh?", "arena_master_melee_pretalk",[]],
...
# Actually there is going to be a fight soon. You can go and hop in if you want to.", "arena_master_melee_talk",[]],
  [anyone,"arena_training_melee_intro_3", [], "Ha ha. You would have to be out of your mind not to. Of course. The melee fights are open to all.\
 Actually there is going to be a fight soon. You can go and hop in if you want to, but first let me explain the different types of fights. Most fighters prefer one of the classic ones, which use either vibroswords or blasters. But, we also have some that use either random weapons, holodroids, or lightsaber fighters if you want a challenge. Which one do you want to join?", "arena_master_melee_talk",[]],
 ...
 And you earned a prize of {reg10} credits for knocking down {reg8} opponents.", "arena_master_pre_talk",[
 ...
 And of course, you earned a prize money of {reg10} credits.", "arena_master_pre_talk",[
 ...
 Not everyone can knock down {reg8} people in the fights. Of course you deserve a prize with that performance: {reg10} credits. Nice, eh?", "arena_master_pre_talk",[
 ...
 And you earned a prize of {reg10} credits for knocking down {reg8} opponents.", "arena_master_pre_talk",
  ...
  [anyone ,"arena_master_fight_result", [(assign, reg10, arena_grand_prize)],
   "Congratulations champion! Your fight there was something to remember! You managed to be the last fighter standing beating down everyone else. And of course you won the grand prize of the fights: {reg10} credits.", "arena_master_pre_talk",[
...
#  [anyone|plyr,"arena_master_talk", [], "About the arena fights...", "arena_master_melee",[]],
  ...
  [anyone|plyr,"arena_master_talk", [(party_get_num_companions,":troops","p_main_party"),(gt,":troops",1)], "I would like to spar with some of my troops.", "arena_master_spar_teams",[]], # Jinnai Sparing Kit
  [anyone|plyr,"arena_master_talk", [(eq, "$arena_tournaments_asked", 0)], "Will there be a tournament in nearby planets soon?", "arena_master_ask_tournaments",[(assign, "$arena_tournaments_asked", 1)]],
...
## Arena sparring begin - Jinnai
  ...
  [anyone,"arena_master_spar_team_one", [(assign,reg0,"$temp"),(store_sub,reg1,reg0,1)], "There {reg1?are:is} currently {reg0} {reg1?troops:troop} on Team One (Red).  Which troop would you like to add?", "arena_master_spar_team_one_choose",[]],
  ...
  [anyone,"arena_master_spar_team_two", [(assign,reg0,"$temp"),(store_sub,reg1,reg0,1)], "There {reg1?are:is} currently {reg0} {reg1?troops:troop} on Team Two (Blue).  Which troop would you like to add?", "arena_master_spar_team_two_choose",[]],
  ...
  [anyone,"arena_master_spar_team_three", [(assign,reg0,"$temp"),(store_sub,reg1,reg0,1)], "There {reg1?are:is} currently {reg0} {reg1?troops:troop} on Team Three (Green).  Which troop would you like to add?", "arena_master_spar_team_three_choose",[]],
  ...
  [anyone,"arena_master_spar_team_four", [(assign,reg0,"$temp"),(store_sub,reg1,reg0,1)], "There {reg1?are:is} currently {reg0} {reg1?troops:troop} on Team Four (Yellow).  Which troop would you like to add?", "arena_master_spar_team_four_choose",[]],
...
#SW - modified arena_master_melee_pretalk to choose weapons
  ...
  #[anyone,"arena_master_melee_pretalk", [], "There will be a fight here soon. You can go and jump in if you like, just choose your equipment first.", "arena_master_weapon_talk",[]],
  [anyone,"arena_master_melee_pretalk", [], "We offer combat for the public all day long with a reward for each opponent you defeat. You can go and jump in if you like...", "arena_master_weapon_talk",[]],
  #weapon_talk
  #[anyone|plyr,"arena_master_weapon_talk", [], "I'm ready to fight, lets choose my equipment.", "arena_master_weapon_2_talk",[]],
  [anyone|plyr,"arena_master_weapon_talk", [], "I'm ready to fight.", "arena_master_weapon_2_talk",[]],
  [anyone|plyr,"arena_master_weapon_talk", [], "Thanks. But I will give my bruises some time to heal.", "arena_master_melee_reject",[]],
  #weapon_2_talk
  #[anyone,"arena_master_weapon_2_talk", [], "What equipment should you and the other fighters use?", "arena_master_melee_talk",[]],
  [anyone,"arena_master_weapon_2_talk", [], "Great! We are always in need of fighters. Now, we have several types of fights. Most fighters prefer one of the classic ones, which use either vibroswords or blasters. But, we also have some that use either random weapons, holodroids, or lightsaber fighters if you want a challenge. Which one do you want to join?", "arena_master_melee_talk",[]],
  
  [anyone|plyr,"arena_master_melee_talk", [], "The classic fight with vibroswords & energy shields.", "arena_master_melee_posttalk",
	[(assign, "$arena_weapons", 1),]],
  [anyone|plyr,"arena_master_melee_talk", [], "The classic fight with blasters & vibroblades.", "arena_master_melee_posttalk",
	[(assign, "$arena_weapons", 3),]],	
  [anyone|plyr,"arena_master_melee_talk", [], "The fight with random weapons.", "arena_master_melee_posttalk",
	[(assign, "$arena_weapons", 4),]],		
  [anyone|plyr,"arena_master_melee_talk", [], "I want to fight the holodroids.", "arena_master_melee_posttalk",
	[(assign, "$arena_weapons", 2),]],
  [anyone|plyr,"arena_master_melee_talk", [], "I want to fight some lightsaber combatants.", "arena_master_melee_posttalk",
  ...
  [anyone,"arena_master_melee_reject", [], "Good choice, that is clever of you.", "arena_master_pre_talk",[]],
...
#SW - new post dialog
  [anyone,"arena_master_melee_posttalk", [(eq,"$arena_weapons",0)], "Ok, if you think you can handle a lightsaber... good luck and be careful.", "close_window",[(call_script, "script_start_arena_battle"),]],
  [anyone,"arena_master_melee_posttalk", [(eq,"$arena_weapons",1)], "Ok, there is one ready to begin now, good luck!", "close_window",[(call_script, "script_start_arena_battle"),]],
  [anyone,"arena_master_melee_posttalk", [(eq,"$arena_weapons",2)], "Ok, they will all be using your same equipment, this should be interesting...", "close_window",[(call_script, "script_start_arena_battle"),]],
  [anyone,"arena_master_melee_posttalk", [(eq,"$arena_weapons",3)], "Ok, there is one ready to begin now, good luck and make sure to give the audience a good show!", "close_window",[(call_script, "script_start_arena_battle"),]],
  [anyone,"arena_master_melee_posttalk", [(eq,"$arena_weapons",4)], "Ok, there is one ready to begin now. Feel free to pick up different weapons on the ground, good luck!", "close_window",[(call_script, "script_start_arena_battle"),]],
...
# "You've won the bet, eh? Let me see. The sum you have earned amounts to {reg5} credits. Here you go.", "arena_master_pre_talk",
...
#    (assign,reg(5),"$arena_win_amount"),
#   ],
# "And you had the good sense to bet on yourself too. Hmm let me see. You have won yourself some {reg5} credits. Here you are.", "arena_master_pre_talk",
#   [(call_script, "script_troop_add_gold", "trp_player","$arena_win_amount"),
#    (assign,"$arena_bet_amount",0),
#    (assign,"$arena_win_amount",0)]],
...
# "Congratulations champion. You made some pretty good moves out there. Here is your share of share of the prize money, 2 credits.", "arena_master_pre_talk",
...
##  [anyone|plyr,"arena_master_will_you_bet", [(store_troop_gold,reg(0)),(ge,reg(0),10)], "I want to bet 10 credits.",
##   "arena_master_bet_placed",[(assign,"$arena_bet_amount",10),(troop_remove_gold, "trp_player",10)]],
##  [anyone|plyr,"arena_master_will_you_bet", [(store_troop_gold,reg(0)),(ge,reg(0),50)], "I want to bet 50 credits.",
##   "arena_master_bet_placed",[(assign,"$arena_bet_amount",50),(troop_remove_gold, "trp_player",50)]],
##  [anyone|plyr,"arena_master_will_you_bet", [(store_troop_gold,reg(0)),(ge,reg(0),100)], "I want to bet 100 credits.",
...
##  [anyone,"arena_master_bet_placed", [(eq,"$arena_join_or_watch",1)], "Hmm. That's good. If you win, you'll get {reg5} credits. And which team do you want to place your bet on?", "arena_master_select_team",
...
######################################################################################
  ...
  [trp_galeas|plyr,"galeas_talk",
   [[store_num_regular_prisoners,reg(0)],[ge,reg(0),1]],
   "Then you'd better bring your credits. I have got prisoners to sell.", "galeas_sell_prisoners",[]],
...
#   "Surrender to a puny farmer like you? Hah. Not likely.", "close_window",[[encounter_attack]]],
#
...
##   "Venture deep into the enemy territory and find myself a convoy to raid. That's the way I will get rich.", "close_window",[(assign, "$g_leave_encounter",1)]],
##
...
##  [anyone,"soldiers_interrogation_4", [], "Hmm. All right. You may go now. But be careful. There is a war going on. The Galaxy is unsafe for travelers.", "close_window",[(assign, "$g_leave_encounter",1)]],
...
# Ryan BEGIN
  ...
  [anyone,"bandit_introduce", [
      (store_random_in_range, ":rand", 11, 15),
        (str_store_string, s11, "@I can smell a rich traveler a mile away. Methinks yours could do with some lightening, eh?"),
        (str_store_string, s12, "@Why, it be another traveler, chance met upon the way! I should warn you, the Galaxy's a mite dangerous for a good {fellow/woman} like you. But for a small donation my boys and I'll make sure you get rightways to your destination, eh?"),
        (str_store_string, s13, "@Well well, look at this! You'd best start coughing up some credits, friend, or me and my boys'll have to break you."),
		(str_store_string, s14, "@There's a toll for passin' through this sector, payable to us, so if you don't mind we'll just be collectin' our due from your account..."),
        (str_store_string_reg, s5, ":rand"),
	#SW - removed snd_encouter_bandits
    #], "{s5}", "bandit_talk",[(play_sound,"snd_encounter_bandits")]],
	 ], "{s5}", "bandit_talk",[]],
  [anyone|plyr,"bandit_talk", [], "I'll give you nothing. Blast the scum!", "close_window",[[encounter_attack]]],
  [anyone|plyr,"bandit_talk", [], "Let's not get carried away. We'll pay to avoid trouble.", "bandit_barter",[]],
  ...
  [anyone|plyr,"bandit_barter_2", [],
   "I don't have that many credits with me", "bandit_barter_3b",[]],
  ...
  [anyone,"bandit_barter", [],
   "Hey, I've heard of you! You slaughter us freebooters like womp rats, and now you expect us to let you go for a few stinking credits?\
 Forget it. You gave us no quarter, and you'll get none from us.", "close_window",[]],
  ...
  [anyone,"bandit_attack", [
      (store_random_in_range, ":rand", 11, 15),
        ...
        (str_store_string, s12, "@We're not afraid of you. Time to bust some heads!"),
        (str_store_string, s13, "@That was a mistake. Now I'm gonna have to make your death long and painful."),
        (str_store_string, s14, "@That's fighting talk. Let's see you back it up with your blaster!"),
        (str_store_string_reg, s5, ":rand"),
      ], "{s5}", "close_window",[]],
...
#Quest dialogs
  ...
  [party_tpl|pt_troublesome_bandits,"start", [(quest_slot_eq, "qst_troublesome_bandits", slot_quest_target_party, "$g_encountered_party")],
   "This must be your unlucky day indeed. We're the baddest guys you could have run into in this quadrant...", "troublesome_bandits_intro_1",[]],
  [anyone|plyr,"troublesome_bandits_intro_1", [],
   "Heh. For me, you are nothing more than walking credits.\
 A merchant in {s1} offered me good money for your heads.",
  ...
  [anyone|plyr,"disbanded_troop_ask", [], "Yes. Let us travel together.", "disbanded_troop_join",[]],
...
# Ryan END
  ...
  [anyone,"start", [(party_slot_eq, "$current_town", slot_mainplanet_lord, "trp_player"),
   ...
   "Greetings, {sir/madam}. How can I serve you today?", "town_merchant_talk",[]],
...
#SW - Bounty Hunting Begin - http://forums.taleworlds.com/index.php/topic,59300.0.html
  [anyone|plyr,"town_dweller_talk", [(check_quest_active, "qst_bounty_1"),
   ...
   "I am looking for a CIS officer named {s4}. I was told they may be here.", "town_dweller_ask_fugitive",[]],
  [anyone|plyr,"town_dweller_talk", [(check_quest_active, "qst_bounty_2"),
   ...
   "I am looking for a farmer named {s4}. I was told they may be here.", "town_dweller_ask_fugitive",[]],
  [anyone|plyr,"town_dweller_talk", [(check_quest_active, "qst_bounty_3"),
   ...
   "I am looking for someone named {s4}. I was told they may be here.", "town_dweller_ask_fugitive",[]],
  [anyone|plyr,"town_dweller_talk", [(check_quest_active, "qst_bounty_4"),
   ...
   "I am looking for a pirate named {s4}. I was told they may be here.", "town_dweller_ask_fugitive",[]],
  [anyone|plyr,"town_dweller_talk", [(check_quest_active, "qst_bounty_5"),
   ...
   "I am looking for a bounty hunter named {s4}. I was told they may be here.", "town_dweller_ask_fugitive",[]],
  [anyone|plyr,"town_dweller_talk", [(check_quest_active, "qst_bounty_6"),
   ...
   "I am looking for a smuggler named {s4}. I was told they may be here.", "town_dweller_ask_fugitive",[]],
# SW -   Bounty Hunting End
   
  [anyone ,"town_dweller_ask_fugitive", [],
   "Strangers come and go to our little planet, {sir/madam}. If he is hiding here, you will surely find him if you look around.", "close_window",[]],
...
# Ryan BEGIN
  ...
  [anyone, "town_dweller_quest_meet_spy_in_enemy_town_chat", [
   ...
   "I've been expecting you. Here they are, make sure they reach {s4} intact and as quickly as your engines will take you.", "town_dweller_quest_meet_spy_in_enemy_town_chat_2",[
...
# Ryan END  
 ...
 If you would like to learn more, you can speak with our planet {reg4?administrator:administrator}. He is nearby, right over there."),
                                    ],
 ...
 My neighbors are too poor themselves to help me.", "town_dweller_poor",[]],
  ...
  [anyone|plyr,"town_dweller_poor", [(store_troop_gold, ":gold", "trp_player"),
   ...
   "Then take these 300 credits. I hope this will help you and your family.", "town_dweller_poor_paid",
  ...
  [anyone,"town_dweller_poor_paid", [], "{My ruler/My good lady}. \
 You are so good and generous. I will tell everyone how you helped us.", "close_window",
  ...
  [anyone,"hall_guard_duty", [], "Yes, {sir/madam}. As you wish.", "close_window",[]],
  
  [anyone|plyr,"hall_guard_talk", [], "I want you to arrest them immediately!", "hall_guard_arrest",[]],
...
######################################
  ...
  [anyone,"member_chat", [], "Yes?", "regular_member_talk",[]],
  ...
  # end of blackjack mod
  [anyone,"view_regular_char_requested", [], "Okay {sir/madam}. Let me tell you all there is to know about me.", "do_regular_member_view_char",[[change_screen_view_character]]],
  ...
  [anyone|plyr,"regular_member_talk", [], "Never mind, carry on.", "close_window",[]],
...
#  [anyone|plyr,"party_encounter_hostile_attacker", [
#                    ],
#   "I will pay you 1000 credits if you just let us go.", "close_window", []],
  [anyone|plyr,"party_encounter_hostile_attacker", [
                    ],
   "We will fight you to the end!", "close_window", []],
...
#post 0907 changes end
  ...
  # #SW - added dialog for a generic catch all instead of the surrender or die below, nevermind, may not be necessary
	# [anyone,
		# "start",
		# [
			# (store_conversation_troop,"$g_talk_troop"),
		...
		# ],
		# "Yes?",
		# "pre_member_chat_generic",
		# []
	# ],
	# [anyone|plyr, "pre_member_chat_generic", [], "I have a question for you.", "member_chat", []],	
	# [anyone|plyr, "pre_member_chat_generic", [], "Nevermind.", "close_window", []],	
...
#  [anyone,"employ_mercenary_requested", [[store_mercenary_price,0],[store_mercenary_wage,1]], "I want {reg0} credits now and {reg1} credits as monthly payment.", "employ_mercenary_2",[]],
...
#  [anyone|plyr,"employ_mercenary_2", [[player_gold_ge,reg(0)],[hero_can_join]], "That's fine. Here's the {reg0} credits. From now on you work for me.", "employ_mercenary_commit",[[troop_remove_gold, "trp_player",reg(0)],[recruit_mercenary]]],
#  [anyone,"employ_mercenary_giveup", [], "Suits me.", "free",[]],
#  [anyone,"employ_mercenary_commit", [], "You got yourself the best fighter in the Galaxy.", "end",[]],
