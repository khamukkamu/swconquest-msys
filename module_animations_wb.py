...
##   [0.8, "jump_end_hard", 29, 54, arf_blend_in_1],
 ...
 ["stand_single", 0, amf_client_prediction,
  ...
  #[4.0, "sword_loop02", 0, 100, arf_cyclic|arf_loop_pos_0_25],
   ...
   [9.0, "stand_1h", 0, 30, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["stand_greatsword", 0, amf_client_prediction,
   [6.0, "greatsword_cstance", 0, 91, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [2.0, "anim_human", 1100, 1120, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.1],  	#acm new
   [6.0, "stand_2h", 0, 30, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["stand_staff", 0, amf_client_prediction,
  ...
  #[2.0, "anim_human", 1500, 1520, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  #acm new
   [9.0, "stand_pole", 0, 30, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
...
#@ [0.8, "run_man_forward_onehanded", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
   ...
   [0.8, "run_onehanded_doublesaber", 0, 25, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9)],
 ],
...
#   [10.0, "anim_human_temp", 0, 10, arf_blend_in_5],
 ...
 ["equip_bayonet", 0, amf_priority_striked|amf_play|amf_restart|amf_client_prediction, 
...
## kham
 ...
 ["crouch_pike_recover",  0, amf_client_prediction,
   [11.0, "crouch_stand_man", 0, 315, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["ready_overswing_spear",0, amf_client_prediction,
   [6.0, "crouch_greatsword_cstance", 0, 170, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],   #Greatsword
 ],
 ["release_overswing_spear", 0, amf_client_prediction,
   [5.0, "crouch_staff_cstance", 0, 120, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  #Staff
 ],
 ...
 ["parried_overswing_spear",  acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_pistol,
   [0.3, "crouch_fire_pistol", 1, 12, blend_in_ready], #Pistol Ready
 ],
 ["blocked_overswing_spear",  acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_pistol,
   [0.3, "crouch_fire_pistol", 12, 21, arf_blend_in_1], #Pistol Release
 ],
...
["ready_overswing_musket", acf_rot_vertical_sword| acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction|amf_rider_rot_thrust,
 ...
 ["ready_thrust_musket",acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
   [ready_durn, "attacks_staff_thrust", 14, 21, blend_in_ready]
 ],
 ["release_thrust_musket",acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play,
   [0.45, "attacks_staff_thrust", 21, 40, blend_in_release]
 ], 
 ["release_thrust_musket_continue", acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
   [0.6, "attacks_staff_thrust", 40, 58, blend_in_release], 
 ],
 ["parried_thrust_musket", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_parried|amf_use_weapon_speed|amf_play,
   [attack_parried_duration_thrust, "anim_human", combat+7316, combat+7313, arf_blend_in_2], 
 ],
 ["blocked_thrust_musket",acf_rot_vertical_bow|acf_anim_length(100), amf_priority_blocked|amf_use_weapon_speed|amf_play,
   [attack_blocked_duration_thrust, "anim_human", combat+7316, combat+7313, arf_blend_in_2], 
 ],
 ...
 ["deflect_forward_onehanded_keep", 0, amf_priority_parried+1|amf_play, 
   [0.6, "anim_human", defend+410, defend+410, arf_blend_in_8],
   [0.6, "anim_human", defend+520, defend+520, arf_blend_in_8],
   [0.6, "anim_human", defend+620, defend+620, arf_blend_in_8],
 ],


["sw_parry_ranged_lightsaber", 0, amf_priority_parried+1|amf_play, 
 [0.6, "parry_attack_thrust_onehanded", 12, 30, arf_blend_in_8],
 [0.6, "defend_up_onehanded", 10, 20, arf_blend_in_8],
...
## [1.5, "anim_horse", 0, 0, arf_cyclic],
 ...
 ["unused_horse_anim_03", 0, 0, [1.0, "anim_horse", 0, 1, 0]],
 ["unused_horse_anim_04", 0, 0, [1.0, "anim_horse", 0, 1, 0]],
 ["unused_horse_anim_05", 0, 0, [1.0, "anim_horse", 0, 1, 0]],
 ["unused_horse_anim_06", 0, 0, [1.0, "anim_horse", 0, 1, 0]],
 ["unused_horse_anim_07", 0, 0, [1.0, "anim_horse", 0, 1, 0]],
 ["unused_horse_anim_08", 0, 0, [1.0, "anim_horse", 0, 1, 0]],
 ["unused_horse_anim_09", 0, 0, [1.0, "anim_horse", 0, 1, 0]],
