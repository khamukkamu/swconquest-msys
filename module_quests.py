...
#SW - modified village to planet in dialogs
 ("deal_with_bandits_at_lords_village", "Save the planet of {s15} from Marauding Bandits", qf_random_quest,
  "{s13} asked you to deal with the bandits who took refuge on the planet of {s15} and then report back to him."
  ),
...
##  ),
 ...
 ("collect_debt", "Collect the debt {s3} owes to {s9}", qf_random_quest,
  ...
  "{s9} asked you to collect the debt of {reg4} credits {s3} owes to him."
  ),
...
# Note : This is defined as the first army quest in module_constants.py:
 ...
 ("deliver_cattle_to_army", "Deliver a herd of {reg3} nerfs to {s13}", qf_random_quest,
  "None"
  ),
...
# Note : This is defined as the first mayor quest in module_constants.py: 
 ...
 ("move_cattle_herd", "Move nerf herd to {s13}", qf_random_quest,
  "Guildmaster of {s10} asked you to move a nerf herd to {s13}."
  ),
 ("escort_merchant_caravan", "Escort Merchant Caravan to {s8}", qf_random_quest,
  "Escort the merchant caravan to the planet of {s8}."
  ),
 ("deliver_wine", "Deliver {reg5} Units of {s6} to {s4}", qf_random_quest,
  "{s9} of {s3} asked you to deliver {reg5} units of {s6} to the cantina in {s4} in 7 days."
  ),
 ...
 ("kidnapped_girl", "Ransom Girl from Bandits", qf_random_quest,
  ...
  "Guildmaster of {s4} gave you {reg12} credits to pay the ransom of a girl kidnapped by bandits.\
 ...
 ("persuade_lords_to_make_peace", "Make Sure Two Lords Do Not Object to Peace", qf_random_quest,
  ...
  "Guildmaster of {s4} promised you {reg12} credits if you can make sure that\
 ...
 ("deal_with_jawas", "Deal with jawas", qf_random_quest,
  "The Guildmaster of {s4} has asked you to deal with several bands of jawas around {s4}, and bring back any goods you recover."
  ),
...
# Note : This is defined as the first village elder quest in module_constants.py:
 ...
 #SW - modified village to planet in dialogs
  "The administrator of the planet of {s3} asked you to bring them {reg5} packs of wheat."
  ), 
 #SW - modified quest
 ...
 ("deliver_cattle", "Deliver a heard of {reg5} nerfs to {s3}", qf_random_quest,
 #SW - modified village to planet in dialogs
  "The administrator of the planet of {s3} asked you to bring a herd of {reg5} nerfs." 
  ), 
...
# Bandit quests: Capture rich merchant, capture banker, kill bountyhunters?..

# Note : This is defined as the last village elder quest in module_constants.py:
 ("eliminate_bandits_infesting_village", "Save the planet of {s7} from Marauding Bandits", qf_random_quest,
  "A citizen from {s7} begged you to save their planet from the bandits that took refuge there."
  ),
