...
#SW - don't modify skill names in this file because when they are exported it uses the new name, instead create a skills.csv 'en' language file
...
skills = [
  ...
  #SW - switching prisoner_management to be a party skill (also had to modify script_game_get_party_prisoner_limit)
  ...
  ("prisoner_management", "Prisoner Management",sf_base_att_cha|sf_effects_party,10,"Every level of this skill increases maximum number of prisoners by %d. (Party skill)"), 
  ...
  ("inventory_management","Cargo Management",sf_base_att_int,10,"Increases ship cargo capacity by +6 per skill level. (Leader skill)"), 
  ("spotting","Sensors",sf_base_att_int|sf_effects_party,10,"Ship sensors range is increased by 10%% per skill level. (Party skill)"),
  ("pathfinding","Navigation",sf_base_att_int|sf_effects_party,10,"Ship map speed is increased by 3%% per skill level. (Party skill)"), 
  ...
  ("horse_archery","Mounted Accuracy",sf_base_att_agi,10,"Reduces damage and accuracy penalties for ranged weapons and throwing when mounted. (Personal skill)"),
  ("riding","Riding",sf_base_att_agi,10,"Enables you to ride speeder bikes of higher difficulty levels and increases your riding speed and manuever. (Personal skill)"),
