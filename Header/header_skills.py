...
knows_deflection_1            = 0x01 << (skl_deflection << 2)
knows_deflection_2            = 0x02 << (skl_deflection << 2)
knows_deflection_3            = 0x03 << (skl_deflection << 2)
knows_deflection_4            = 0x04 << (skl_deflection << 2)
knows_deflection_5            = 0x05 << (skl_deflection << 2)
knows_deflection_6            = 0x06 << (skl_deflection << 2)
knows_deflection_7            = 0x07 << (skl_deflection << 2)
knows_deflection_8            = 0x08 << (skl_deflection << 2)
knows_deflection_9            = 0x09 << (skl_deflection << 2)
knows_deflection_10           = 0x0A << (skl_deflection << 2)
knows_deflection_11           = 0x0B << (skl_deflection << 2)
knows_deflection_12           = 0x0C << (skl_deflection << 2)
knows_deflection_13           = 0x0D << (skl_deflection << 2)
knows_deflection_14           = 0x0E << (skl_deflection << 2)
knows_deflection_15           = 0x0F << (skl_deflection << 2)
